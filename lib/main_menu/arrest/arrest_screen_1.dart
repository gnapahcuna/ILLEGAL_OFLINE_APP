...
class _ArrestMainScreenFragmentState extends State<ArrestMainScreenFragment>  with TickerProviderStateMixin {
  ...
  Future<bool> onLoadActionInsAll(/*Map map*/) async {
    ...
    Map map_transec = {
      ...
      "RUNNING_OFFICE_CODE": _itemsLocale.SUB_DISTICT.OFFICE_CODE
    };
    await new TransectionFuture()
      ...
      if (_itemTransection.length != 0) {
        ...
        String date_auto = (int.parse(
            ...
            .substring(2);
        transection_no =
            "TN" + _itemsLocale.SUB_DISTICT.OFFICE_CODE + date_auto + "00001";
      }
    });
    ...
    await future.apiRequestInsAll(putDataRequest()).then((onValue) async{
      if(onValue!=null){
          ...
          if(item.ArrestIndictmentDetail.length>0) {
            item.ArrestIndictmentDetail.forEach((item) {
              ArrestLawbreaker.add({
                ...
                "INDICTMENT_ID": "",
                "LAWBREAKER_ID": onValue.ArrestLawbreaker[item.INDEX]
                    .LAWBREAKER_ID,
                "IS_ACTIVE": 1
              });
            });
        ...
        await new TransectionFuture().apiRequestArrestReport(map_gen).then((onValue) {
  ...
  _navigateMap(BuildContext context) async {
    ...
    if(result.toString()!="Back"){
      if(_onEdited){
        ...
        String address = /*list_update_location.ADDRESS_NO+*/(list_update_location.ALLEY.isEmpty?"":"ซอย "+list_update_location.ALLEY)
    ...
    if ((_onEdited
      ...
      if (_onEdited) {
        ...
        if (list_delete_notice.length > 0 ||
          ...
          //update indic product only
          list_update_indicment_pro.forEach((item){
            map_up_indicment_pro.add({
              "PRODUCT_INDICTMENT_ID": item.PRODUCT_INDICTMENT_ID,
              "PRODUCT_ID": item.PRODUCT_ID,
              "INDICTMENT_ID": item.INDICTMENT_ID,
              "SIZES_UNIT_ID": item.SIZES_UNIT_ID,
              "QUATITY_UNIT_ID": item.QUATITY_UNIT_ID,
              "VOLUMN_UNIT_ID": item.VOLUMN_UNIT_ID,
              "SIZES": item.SIZES,
                ...
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      Container(
                        padding: paddingLabel,
                        child: Text("เลขที่ใบแจ้งความ", style: textLabelStyle,),
                      ),
                      Row(
                        children: <Widget>[
                          Expanded(
                        ...
                        child: SingleChildScrollView(
                          child: Column(
                            ...
                            children: <Widget>[
                              ...
                              Container(
                                padding: paddingInputBox,
                                child: Text("ผู้รับแจ้งความ " +_arrestMain.ArrestNotice[index]
...
//************************start_tab_4*******************************
  ...
  Future<bool> onLoadActionCountryMaster(var itemPerson) async {
    ...
    Map map = {
      "DOCUMENT_TYPE": 3,
      "REFERENCE_CODE": itemPerson.PERSON_ID
    };
                                ...
                                child: Text(
                                  (index + 1).toString() + ". " +
                                      ...
                                      (_itemsDataTab5[index].DEGREE != null
                                          ...
                                          ' ดีกรี ')
                                          : ' ') +
                                      (_itemsDataTab5[index].SIZES != null
                                          ? (_itemsDataTab5[index].SIZES.toString()+' ')
                                              :'')+
                                      (_itemsDataTab5[index].SIZES_UNIT != null
                              ...
                              child: Column(
                                ...
                                children: <Widget>[
                                  ...
                                  Container(
                                    padding: paddingLabel,
                                    child: Text(
                                      _itemsDataTab5[index].VOLUMN!=null
                                ...
                                child: Text(
                                  (index + 1).toString() + ". " +
                                      ...
                                      (_arrestMain.ArrestProduct[index].DEGREE != null
                                          ...
                                          ' ดีกรี ')
                                          : ' ') +
                                      (_arrestMain.ArrestProduct[index].SIZES != null
                                          ? (_arrestMain.ArrestProduct[index].SIZES.toString()+' ')
                                          :'')+
                                      (_arrestMain.ArrestProduct[index].SIZES_UNIT != null
                                        ...
                                        child: Text(
                                          (j + 1).toString() + ". " +
                                              ...
                                              (_itemsInitTab6[index]
                                                  ...
                                                  : ' ') +
                                          (_itemsInitTab6[index]
                                              .ArrestIndictmentProduct[j].SIZES != null
                                              ? (_itemsInitTab6[index]
                                              .ArrestIndictmentProduct[j].SIZES.toString()+' ')
                                              :'')+
                                              (_itemsInitTab6[index]
                                                  .ArrestIndictmentProduct[j].SIZES_UNIT != null
                                                  ? (_itemsInitTab6[index]
                                                  .ArrestIndictmentProduct[j].SIZES_UNIT.toString())
                                                  :''),
                                          style: textDataStyle,),
                                      ),
                                    ),
      ...
      ListView.builder(
        ...
        itemBuilder: (BuildContext context, int index) {
          return InkWell(
            onTap: () {
              _onEdited
                  ? _navigateSelection_top(context, 'มาตรา ' +
                        ...
                        child: InkWell(
                          onTap: () {
                            ...
                            _navigateSearchSelectionEdit(
                                ...
                                _arrestMain.ArrestProduct);//ตัวลิ้ง
                          },
                          child: Container(
                              child: Text("แก้ไข",             
                                style: textLabelDeleteStyle,)
                                    ...
                                    child: Container(
                                      ...
                                      child: Text(
                                        (j + 1).toString() + ". " +
                                            ...
                                            (_arrestMain.ArrestIndictment[index]
                                                .ArrestIndictmentProduct[j]
                                                .DEGREE != null||_arrestMain.ArrestIndictment[index]
                                                .ArrestIndictmentProduct[j]
                                                .DEGREE > 0
                                                ? (_arrestMain
                                                .ArrestIndictment[index]
      ...
      child: Column(
        ...
        children: <Widget>[
                        ...
                        child: new GestureDetector(
                          onTap: () {
                            ...
                            _navigateSearchSelection(
                                ...
                                /*_arrestMain.ArrestProduct*/_itemsDataTab5OpsSaved)
                                : _navigateSearchSelection(
                                context, _itemsDataTab4, /*_itemsDataTab5*/_itemsDataTab5Ops);
                          },
                          child: new ListTile(
                            leading: new Icon(Icons.search),
                            title: new Row(
          ...
          _onSaved ? Container()
            ...
            child: Text(
              'ข้อกล่าวหาที่กระทำผิดมากที่สุด', style: textStyleTitle,),
          ) : Container()),
          Expanded(
                        ...
                        Navigator.push(
                          ...
                          MaterialPageRoute(builder: (context) =>
                              TabScreenArrest8Dowload(
                                ...
                                FILE_NAME: _itemsDataTab8[index].FormsCode,
                              )),
                        );
                      }
                  ),
...
//************************end_tab_8*****************************
  ...
  Future<bool> onLoadActionProvinceMaster(int COUNTRY_ID,String ProvinceName,
      String DistrictName,String SubDistrictName) async {
    Map map = {
      "TEXT_SEARCH": "",
    ...
    await new ArrestFutureMaster().apiRequestMasSubDistrictgetByCon(map).then((
      ...
      if (ItemSubDistrict != null) {
        ItemSubDistrict.RESPONSE_DATA.forEach((subdistrict) {
          if (SubDistrictName.trim().endsWith(
            ...
            setState(() {
              ...
              if(widget.IsPreview||widget.IsUpdate){
                ...
                _itemsLocale = new ItemsListArrestLocation(
                    ...
                    sDistrict,
                    sSubDistrict,
                    _arrestMain.ArrestLocale.first.ROAD!=null?_arrestMain.ArrestLocale.first.ROAD:"",
                    _arrestMain.ArrestLocale.first.ALLEY!=null?_arrestMain.ArrestLocale.first.ALLEY:"",
                    _arrestMain.ArrestLocale.first.ADDRESS_NO!=null?_arrestMain.ArrestLocale.first.ADDRESS_NO:"",
                    _arrestMain.ArrestLocale.first.GPS!=null?_arrestMain.ArrestLocale.first.GPS:"",
                    placeAddress,
                    false,
                    ""
                );
              ...
              print("success : "+_itemsLocale.PROVINCE.PROVINCE_NAME_TH);
