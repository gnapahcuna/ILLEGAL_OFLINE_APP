                      ...
                      child: Column(
                        ...
                        children: <Widget>[
                          ...
                          Padding(
                            padding: paddingInputBox,
                            child: TextField(
                              focusNode: itemsController[index]
                                  .myFocusNodeQuantity,
        ...
        onPressed: () {
          for (int i = 0; i < widget.ItemsData.length; i++) {
            if (itemsController[i].editQuantity.text.isEmpty ||
              ...
              widget.ItemsData[i].SIZES_UNIT_ID = itemsController[i].dropdownValueSizeUnit.SIZE_ID;
              widget.ItemsData[i].QUATITY_UNIT_ID = itemsController[i].dropdownValueQuantityUnit.UNIT_ID;
              widget.ItemsData[i].VOLUMN_UNIT_ID = itemsController[i].dropdownValueSizeUnit.SIZE_ID;
              widget.ItemsData[i].SIZES =
              itemsController[i].editSize.text.isEmpty
                  ? null
                  : double.parse(itemsController[i].editSize.text.replaceAll(",",""));
              widget.ItemsData[i].QUANTITY =
                  double.parse(itemsController[i].editQuantity.text.replaceAll(",",""));
              widget.ItemsData[i].VOLUMN =
              itemsController[i].editVolume.text.isEmpty
                  ? null
                  : double.parse(itemsController[i].editVolume.text.replaceAll(",",""));
              widget.ItemsData[i].SIZES_UNIT =
              itemsController[i].dropdownValueSizeUnit == null
                  ? null
                  : itemsController[i].dropdownValueSizeUnit.SIZE_NAME_TH;
              widget.ItemsData[i].QUANTITY_UNIT =
                  itemsController[i].dropdownValueQuantityUnit.UNIT_NAME_TH;
              widget.ItemsData[i].VOLUMN_UNIT =
              itemsController[i].editVolumeUnit.text.isEmpty
                  ? null
                  : itemsController[i].editVolumeUnit.text;
            }
          }
