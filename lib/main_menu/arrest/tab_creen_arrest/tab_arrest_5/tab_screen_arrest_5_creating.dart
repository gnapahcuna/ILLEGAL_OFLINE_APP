...
class _TabScreenArrest5AddState extends State<TabScreenArrest5Creating> {
  List _itemsData = [];
  GlobalKey key_product_group = new GlobalKey<
      AutoCompleteTextFieldState<ItemsListProductGroup>>();
  ...
  void initState() {
    ...
    if (widget.IsUpdate) {
      ...
      this.onLoadActionProuductCategoryMaster(
          widget.ItemsProductGroup.RESPONSE_DATA[0].PRODUCT_GROUP_ID);
    }
  }
  ...
  void _onSaved(mContext) async {
    ...
    if (editCapacity.text.isEmpty || dropdownValueCapacityUnit == null) {
      ...
      _itemsData.add(new ItemsListArrest5(
          ...
          sProductCategory != null
              ? sProductCategory.PRODUCT_CATEGORY_NAME
              : "",
          sProductType != null ? sProductType.PRODUCT_TYPE_NAME : "",
          null,
          null,
          sProductBrand != null
              ? sProductBrand.PRODUCT_BRAND_NAME_TH
              : (_textListProductBrand != null
          ...
          editCapacity.text.isEmpty
              ? null
              : double.parse(editCapacity.text.replaceAll(",","")),
          dropdownValueSizeUnit!=null?dropdownValueSizeUnit.SIZE_ID:null,
          editSize.text.isEmpty
              ? null
              : double.parse(editSize.text.replaceAll(",","")),
      ...
      if(widget.IsUpdate){
        ...
        widget.ItemsDataProduct.PRODUCT_CATEGORY_NAME = sProductCategory != null
            ? sProductCategory.PRODUCT_CATEGORY_NAME
            : null;
        widget.ItemsDataProduct.PRODUCT_TYPE_NAME = sProductType != null ? sProductType.PRODUCT_TYPE_NAME : "";
        widget.ItemsDataProduct.PRODUCT_BRAND_NAME_TH = sProductBrand != null
            ? sProductBrand.PRODUCT_BRAND_NAME_TH
            : (_textListProductBrand != null
            ? _textListProductBrand.textField.controller.text
            : "");

        widget.ItemsDataProduct.SIZES = editSize.text.isEmpty
            ? null
            : double.parse(editSize.text.replaceAll(",",""));
        widget.ItemsDataProduct.QUANTITY = editCapacity.text.isEmpty
            ? null
            : double.parse(editCapacity.text.replaceAll(",",""));
        ...
        item_ops.add(new ItemsListArrestOps(
            ...
            editCapacity.text.isEmpty
                ? null
                : double.parse(editCapacity.text),
            dropdownValueSizeUnit!=null?dropdownValueSizeUnit.SIZE_ID:null,
            editSize.text.isEmpty
                ? null
                : double.parse(editSize.text),
            dropdownValueCapacityUnit!=null?dropdownValueCapacityUnit.UNIT_ID:null,
      ...
      ItemsListArrest5Test items_test = new ItemsListArrest5Test(
          _itemsData,
          item_ops);
  ...
  Future<bool> onLoadActionInsProductAllMaster(Map map) async {
    ...
    await new ArrestFutureMaster().apiRequestMasProductMappinginsAll(map).then((
        onValue) {
    ...
    await new ArrestFutureMaster()
        .apiRequestMasProductMappinggetByCon(map_id)
        .then((onValue) {
  ...
  void setAutoCompleteProductGroup() {
    _textListProductGroup = new AutoCompleteTextField<ItemsListProductGroup>(
      ...
      itemSubmitted: (item) {
        setState(() {
          sProductGroup = item;
          _textListProductGroup.textField.controller.text =
              sProductGroup.PRODUCT_GROUP_NAME.toString();
      ...
      sProductGroup == null
          ...
          child: new ListTile(
            title: new Text(
                suggestion.PRODUCT_GROUP_NAME, style: textInputStyle),),
          padding: EdgeInsets.all(8.0)) : Container(),
      itemSorter: (a, b) =>
      a.PRODUCT_GROUP_ID == b.PRODUCT_GROUP_ID ? 0 : a.PRODUCT_GROUP_ID >
          b.PRODUCT_GROUP_ID ? -1 : 1,
      itemFilter: (suggestion, input) {
        sProductGroup = null;
        return suggestion.PRODUCT_GROUP_NAME.toLowerCase().startsWith(
            input.toLowerCase());
      },
    );
  }
  ...
  void setAutoCompleteProductCategory() {
    GlobalKey key_product_cate = new GlobalKey<
        AutoCompleteTextFieldState<ItemsListProductCategory>>();
    ...
    new AutoCompleteTextField<ItemsListProductCategory>(
      ...
      sProductCategory == null
          ...
          child: new ListTile(
            title: new Text(
                suggestion.PRODUCT_CATEGORY_NAME, style: textInputStyle),),
          padding: EdgeInsets.all(8.0)) : Container(),
      itemSorter: (a, b) =>
      a.PRODUCT_CATEGORY_ID == b.PRODUCT_CATEGORY_ID
          ? 0
          : a.PRODUCT_CATEGORY_ID > b.PRODUCT_CATEGORY_ID ? -1 : 1,
      itemFilter: (suggestion, input) {
        sProductCategory = null;
        return suggestion.PRODUCT_CATEGORY_NAME.toLowerCase().startsWith(
            input.toLowerCase());
      },
    );
  }
  ...
  void setAutoCompleteProductType() {
    GlobalKey key_product_type = new GlobalKey<
        AutoCompleteTextFieldState<ItemsListProductType>>();
    ...
    new AutoCompleteTextField<ItemsListProductType>(
      ...
      sProductType == null
          ...
          child: new ListTile(
            title: new Text(
                suggestion.PRODUCT_TYPE_NAME, style: textInputStyle),),
          padding: EdgeInsets.all(8.0)) : Container(),
      itemSorter: (a, b) =>
      a.PRODUCT_TYPE_ID == b.PRODUCT_TYPE_ID ? 0 : a.PRODUCT_TYPE_ID >
          b.PRODUCT_TYPE_ID ? -1 : 1,
      itemFilter: (suggestion, input) {
        sProductType = null;
        return suggestion.PRODUCT_TYPE_NAME.toLowerCase().startsWith(
            input.toLowerCase());
      },
    );
  }
  ...
  void setAutoCompleteProductBrand() {
    GlobalKey key_product_brand = new GlobalKey<
        AutoCompleteTextFieldState<ItemsListProductBrand>>();
    ...
    new AutoCompleteTextField<ItemsListProductBrand>(
      ...
      sProductBrand == null
          ...
          child: new ListTile(
            title: new Text(
                suggestion.PRODUCT_BRAND_NAME_TH, style: textInputStyle),),
          padding: EdgeInsets.all(8.0)) : Container(),
      itemSorter: (a, b) =>
      a.PRODUCT_BRAND_ID == b.PRODUCT_BRAND_ID ? 0 : a.PRODUCT_BRAND_ID >
          b.PRODUCT_BRAND_ID ? -1 : 1,
      itemFilter: (suggestion, input) {
        sProductBrand = null;
        return suggestion.PRODUCT_BRAND_NAME_TH.toLowerCase().startsWith(
            input.toLowerCase());
      },
    );
  }
  ...
  void setAutoCompleteProductSecondBrand() {
    GlobalKey key_product_brand = new GlobalKey<
        AutoCompleteTextFieldState<ItemsListProductSubBrand>>();
    _textListProductSecondBrand =
    new AutoCompleteTextField<ItemsListProductSubBrand>(
      style: textInputStyle,
      decoration: InputDecoration(
        border: InputBorder.none,
      ),
      ...
      itemSubmitted: (item) {
        setState(() {
          _textListProductSecondBrand.textField.controller.text =
              item.PRODUCT_SUBBRAND_NAME_TH.toString();
          sProductSubBrand = item;

          sProductModel = null;
          _onSelectProductModel(
              sProductSubBrand.PRODUCT_SUBBRAND_ID
          );
      ...
      sProductSubBrand == null
          ...
          child: new ListTile(
            title: new Text(
                suggestion.PRODUCT_SUBBRAND_NAME_TH, style: textInputStyle),),
          padding: EdgeInsets.all(8.0)) : Container(),
      itemSorter: (a, b) =>
      a.PRODUCT_SUBBRAND_ID == b.PRODUCT_SUBBRAND_ID ? 0 : a
          .PRODUCT_SUBBRAND_ID >
          b.PRODUCT_SUBBRAND_ID ? -1 : 1,
      itemFilter: (suggestion, input) {
        sProductSubBrand = null;
        return suggestion.PRODUCT_SUBBRAND_NAME_TH.toLowerCase().startsWith(
            input.toLowerCase());
      },
    );
  }
  ...
  void setAutoCompleteProductModel() {
    GlobalKey key_product_brand = new GlobalKey<
        AutoCompleteTextFieldState<ItemsListProductModel>>();
    _textListProductSecondBrand =
    new AutoCompleteTextField<ItemsListProductModel>(
      style: textInputStyle,
      decoration: InputDecoration(
        border: InputBorder.none,
      ),
      ...
      itemSubmitted: (item) {
        setState(() {
          _textListProductSecondBrand.textField.controller.text =
              item.PRODUCT_MODEL_NAME_TH.toString();
          sProductModel = item;
          _setProductDetail();
        });
      },
      ...
      sProductModel == null
          ...
          child: new ListTile(
            title: new Text(
                suggestion.PRODUCT_MODEL_NAME_TH, style: textInputStyle),),
          padding: EdgeInsets.all(8.0)) : Container(),
      itemSorter: (a, b) =>
      a.PRODUCT_MODEL_ID == b.PRODUCT_MODEL_ID ? 0 : a.PRODUCT_MODEL_ID >
          b.PRODUCT_MODEL_ID ? -1 : 1,
      itemFilter: (suggestion, input) {
        sProductModel = null;
        return suggestion.PRODUCT_MODEL_NAME_TH.toLowerCase().startsWith(
            input.toLowerCase());
      },
    );
  }
  ...
  void _setProductDetail() {
    ...
    editBrandDetail.text = (sProductGroup != null ?
    sProductGroup.PRODUCT_GROUP_NAME.toString() : "") + " " +
        (sProductCategory != null ?
        sProductCategory.PRODUCT_CATEGORY_NAME.toString() : "") + " " +
        (sProductType != null ?
        sProductType.PRODUCT_TYPE_NAME.toString() : "") + " " +
        (sProductBrand != null ?
        sProductBrand.PRODUCT_BRAND_NAME_TH.toString()
            : (_textListProductBrand != null
            ? _textListProductBrand.textField.controller.text
            : "")) + " " +
        (sProductSubBrand != null ?
        sProductSubBrand.PRODUCT_SUBBRAND_NAME_TH.toString()
            : (_textListProductSecondBrand != null
            ? editSecondaryBrand.text
            : "")) + " " +
        (sProductModel != null ?
        sProductModel.PRODUCT_MODEL_NAME_TH.toString()
            : (_textListProductModel != null
            ? _textListProductModel.textField.controller.text
            : "")) + " " +
        editNumbeMotor.text + " " + editNumberTank.text;
    ;
  }
  ...
  Widget _buildInput() {
    ...
    return new Column(
      ...
      children: <Widget>[
              ...
              child: new GestureDetector(
                ...
                child: new ListTile(
                  ...
                  title: new Row(
                    ...
                    children: <Widget>[
                      Text('ค้นหาของกลาง', style: TextStyle(
                          fontSize: 16.0,
            ...
            child: DropdownButton<ItemsListProductGroup>(
              ...
              onChanged: (ItemsListProductGroup newValue) {
                setState(() {
                  ...
                  if (sProductGroup.PRODUCT_GROUP_NAME.endsWith("รถยนต์") ||
                      sProductGroup.PRODUCT_GROUP_NAME.endsWith(
                          "รถจักรยานยนต์")) {
                    IsMotor = true;
                  } else {
                    IsMotor = false;
              ...
              items: widget.ItemsProductGroup.RESPONSE_DATA
                ...
                return DropdownMenuItem<ItemsListProductGroup>(
                  value: value,
                  child: Text(value.PRODUCT_GROUP_NAME.toString(),
                    style: textInputStyle,),
                );
              })
                  .toList(),
            ...
            child: ItemsProductType != null ? DropdownButton<
              ...
              items: ItemsProductType.RESPONSE_DATA
                ...
                return DropdownMenuItem<ItemsListProductType>(
                  value: value,
                  child: Text(
                    value.PRODUCT_TYPE_NAME.toString(), style: textInputStyle,),
                );
              })
                  .toList(),
            ) : Container(
        ...
        _buildLine,
        sProductGroup != null && (sProductGroup.PRODUCT_GROUP_ID == 6 ||
            sProductGroup.PRODUCT_GROUP_ID == 7)
            ? Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: <Widget>[
            Container(
            ...
            Padding(
                padding: paddingInputBox,
                child: _textListProductSecondBrand /*TextField(
            ...
            Padding(
                padding: paddingInputBox,
                child: _textListProductModel /*TextField(
                  ...
                  Container(
                    ...
                    child: DropdownButtonHideUnderline(
                      child: DropdownButton<ItemsListProductSize>(
                        ...
                        items: dropdownItemsSizeUnit.RESPONSE_DATA
                            .map<DropdownMenuItem<ItemsListProductSize>>((ItemsListProductSize value) {
  ...
  void _onSelectProductType(int PRODUCT_GROUP_ID, int PRODUCT_CATEGORY_ID,
      int PRODUCT_TYPE_ID) async {
    await onLoadActionProuductBrandMaster(
        PRODUCT_GROUP_ID, PRODUCT_CATEGORY_ID, PRODUCT_TYPE_ID);
  }
  ...
  Future<bool> onLoadActionProuductTypeMaster(int PRODUCT_CATEGORY_ID) async {
    ...
    await new ArrestFutureMaster().apiRequestMasProductTypegetByCon(map).then((
        onValue) {
      ItemsProductType = onValue;
      if (ItemsProductType.SUCCESS &&
          ItemsProductType.RESPONSE_DATA.length > 0) {
        ...
        if (ItemsProductType != null) {
          ItemsProductType.RESPONSE_DATA.forEach((item) {
            if (item.PRODUCT_TYPE_ID ==
                widget.ItemsDataProduct.PRODUCT_TYPE_ID) {
              sProductType = item;
            }
          });
        }
    ...
    this.onLoadActionProuductBrandMaster(
        sProductGroup.PRODUCT_GROUP_ID, PRODUCT_CATEGORY_ID, null);
    setState(() {});
    return true;
  }
  ...
  Future<bool> onLoadActionProuductCategoryMaster(int PRODUCT_GROUP_ID) async {
    ...
    await new ArrestFutureMaster()
      ...
      if (ItemsProductCategory.SUCCESS &&
          ItemsProductCategory.RESPONSE_DATA.length > 0) {
        ...
        if (ItemsProductCategory != null) {
          ItemsProductCategory.RESPONSE_DATA.forEach((item) {
            ...
            if (item.PRODUCT_CATEGORY_ID ==
                widget.ItemsDataProduct.PRODUCT_CATEGORY_ID) {
              sProductCategory = item;
            }
          });
        }
        if (sProductCategory != null) {
          this.onLoadActionProuductTypeMaster(
              sProductCategory.PRODUCT_CATEGORY_ID);
        }
      }
  ...
  Future<bool> onLoadActionProuductBrandMaster(int PRODUCT_GROUP_ID,
      int PRODUCT_CATEGORY_ID, int PRODUCT_TYPE_ID) async {
    Map map = {
      "TEXT_SEARCH": "",
      "PRODUCT_GROUP_ID": PRODUCT_GROUP_ID,
      "PRODUCT_CATEGORY_ID": PRODUCT_CATEGORY_ID != null
          ? PRODUCT_CATEGORY_ID
          : "",
      "PRODUCT_TYPE_ID": PRODUCT_TYPE_ID != null ? PRODUCT_TYPE_ID : "",
      "PRODUCT_SUBTYPE_ID": "",
      "PRODUCT_SUBSETTYPE_ID": "",
      "PRODUCT_BRAND_ID": ""
    };

    await new ArrestFutureMaster().apiRequestMasProductBrandgetByCon(map).then((
        onValue) {
      ItemsProductBrand = onValue;
      if (ItemsProductBrand.SUCCESS &&
          ItemsProductBrand.RESPONSE_DATA.length > 0) {
        ...
        if (widget.IsUpdate) {
          ItemsProductBrand.RESPONSE_DATA.forEach((f) {
            if (f.PRODUCT_BRAND_ID ==
                widget.ItemsDataProduct.PRODUCT_BRAND_ID) {
              sProductBrand = f;
              _textListProductBrand.textField.controller.text =
                  sProductBrand.PRODUCT_BRAND_NAME_TH;
            }
  ...
  Future<bool> onLoadActionProuductSubBrandMaster(int PRODUCT_BRAND_ID) async {
    Map map = {
      "TEXT_SEARCH": "",
      "PRODUCT_BRAND_ID": PRODUCT_BRAND_ID != null ? PRODUCT_BRAND_ID : "",
      "PRODUCT_SUBBRAND_ID": ""
    };

    await new ArrestFutureMaster()
        .apiRequestMasProductSubBrandgetByCon(map)
        .then((onValue) {
      print(onValue.SUCCESS.toString() + ", " +
          onValue.RESPONSE_DATA[0].PRODUCT_SUBBRAND_NAME_TH);
      ItemsProductSubBrand = onValue;
      if (ItemsProductSubBrand.SUCCESS &&
          ItemsProductSubBrand.RESPONSE_DATA.length > 0) {
        setAutoCompleteProductSecondBrand();
      }

      if (sProductSubBrand != null) {
        this.onLoadActionProuductModelMaster(
            PRODUCT_BRAND_ID, sProductSubBrand.PRODUCT_SUBBRAND_ID);
      }
    });
    setState(() {});
    return true;
  ...
  Future<bool> onLoadActionProuductModelMaster(int PRODUCT_BRAND_ID,
      int PRODUCT_SUBBRAND_ID) async {
    Map map = {
      "TEXT_SEARCH": "",
      "PRODUCT_BRAND_ID": PRODUCT_BRAND_ID == null ? "" : PRODUCT_BRAND_ID,
      "PRODUCT_SUBBRAND_ID": PRODUCT_SUBBRAND_ID == null
          ? ""
          : PRODUCT_SUBBRAND_ID,
      "PRODUCT_MODEL_ID": ""
    };

    await new ArrestFutureMaster().apiRequestMasProductModelgetByCon(map).then((
        onValue) {
      print(onValue.SUCCESS.toString() + ", " +
          onValue.RESPONSE_DATA[0].PRODUCT_MODEL_NAME_TH);
      ItemsProductModel = onValue;
      if (ItemsProductModel.SUCCESS &&
          ItemsProductModel.RESPONSE_DATA.length > 0) {
