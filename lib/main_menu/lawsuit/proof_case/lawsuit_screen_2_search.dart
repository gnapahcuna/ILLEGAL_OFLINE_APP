                              ...
                              onPressed: () {
                                Map map = {
                                  ...
                                  "LAWSUILT_DATE_FROM": editLawsuitDateStart
                                      .text.isEmpty ? "" : DateFormat('yyyy-MM-dd').format(_dtDateLawsuitStart)
                                      .toString(),
                                  "LAWSUILT_DATE_TO": editLawsuitDateEnd.text
                                      .isEmpty ? "" : DateFormat('yyyy-MM-dd').format(_dtDateLawsuitEnd)
                                      .toString(),
                                  ...
                                  "IS_LAWSUIT_COMPLETE": IsLawsuitComplete
                                      ? 1
                                      : 0,
                                  "ACCOUNT_OFFICE_CODE": /*widget.ItemsPerson.WorkOffCode*/""
                                };
