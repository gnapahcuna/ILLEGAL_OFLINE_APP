      ...
      child: new Column(
        ...
        children: <Widget>[
          Container(
            ...
            child: Text("เลขที่โอนย้าย", style: textLabelStyle,),
          ),
          Padding(
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    Container(
                      padding: paddingLabel,
                      child: Text("วันที่โอนย้าย", style: textLabelStyle,),
                    ),
                    Padding(
                      padding: paddingInputBox,
                      child: TextField(
          ...
          Container(
            padding: paddingLabel,
            child: Text("ผู้โอนย้าย", style: textLabelStyle,),
          ),
          Padding(
            padding: paddingInputBox,
            child: TextField(
  ...
  Widget build(BuildContext context) {
    ...
    return new WillPopScope(
      ...
      appBar: PreferredSize(
        ...
        child: AppBar(
          title: new Text("ค้นหางานทำลายของกลาง",
