...
class ManageEvidenceFuture{
  ...
  Future<List<ItemsEvidenceOutList>> apiRequestEvidenceOutListgetByConAdv(Map jsonMap) async {
    //encode Map to JSON
    var body = json.encode(jsonMap);
    final response = await http.post(
      serv
          .Server()
          .IPAddressEvidenceOut + "/EvidenceOutListgetByConAdv",
      headers: {"Content-Type": "application/json"},
      body: body,
    );
    if (response.statusCode == 200) {
      print('test');
      List responseJson = json.decode(response.body);
      return responseJson.map((m) => new ItemsEvidenceOutList.fromJson(m))
          .toList();
    } else {
      print('Something went wrong. \nResponse Code : ${response.statusCode}');
    }
  ...
  //Evidence
  Future<ItemsEvidenceOutMain> apiRequestEvidenceOutgetByCon(Map jsonMap) async {
    //encode Map to JSON
    var body = json.encode(jsonMap);
    final response = await http.post(
      serv
          .Server()
          .IPAddressEvidenceOut + "/EvidenceOutgetByCon",
      headers: {"Content-Type": "application/json"},
      body: body,
    );
    if (response.statusCode == 200) {
  ...
  Future<ItemsResponseEvidenceOut> apiRequestEvidenceOutinsAll(Map jsonMap) async {
    //encode Map to JSON
    var body = json.encode(jsonMap);
    final response = await http.post(
      serv
          .Server()
          .IPAddressEvidenceOut + "/EvidenceOutinsAll",
      headers: {"Content-Type": "application/json"},
      body: body,
    );
    if (response.statusCode == 200) {
  ...
  Future<ItemsArrestResponseMessage> apiRequestEvidenceOutupdByCon(Map jsonMap) async {
    //encode Map to JSON
    var body = json.encode(jsonMap);
    final response = await http.post(
      serv
          .Server()
          .IPAddressEvidenceOut + "/EvidenceOutupdByCon",
      headers: {"Content-Type": "application/json"},
      body: body,
    );
    if (response.statusCode == 200) {
  ...
  Future<ItemsArrestResponseMessage> apiRequestEvidenceOutupdDelete(Map jsonMap) async {
    //encode Map to JSON
    var body = json.encode(jsonMap);
    final response = await http.post(
      serv
          .Server()
          .IPAddressEvidenceOut + "/EvidenceOutupdDelete",
      headers: {"Content-Type": "application/json"},
      body: body,
    );
    if (response.statusCode == 200) {
  ...
  Future<ItemsArrestResponseMessage> apiRequestEvidenceOutStockBalanceupdByCon(Map jsonMap) async {
    //encode Map to JSON
    var body = json.encode(jsonMap);
    final response = await http.post(
      serv
          .Server()
          .IPAddressEvidenceOut + "/EvidenceOutStockBalanceupdByCon",
      headers: {"Content-Type": "application/json"},
      body: body,
    );
    if (response.statusCode == 200) {
  ...
  Future<List<EvidenceInventoryList>> apiRequestEvidenceInventoryListgetByEvidenceInItemCode(Map jsonMap) async {
    //encode Map to JSON
    var body = json.encode(jsonMap);
    final response = await http.post(
      serv
          .Server()
          .IPAddressEvidenceOut + "/EvidenceInventoryListgetByEvidenceInItemCode",
      headers: {"Content-Type": "application/json"},
      body: body,
    );
    if (response.statusCode == 200) {
      List responseJson = json.decode(response.body);
      return responseJson.map((m) => new EvidenceInventoryList.fromJson(m))
          .toList();
    } else {
      print('Something went wrong. \nResponse Code : ${response.statusCode}');
    }
  }
  Future<List<EvidenceInventory>> apiRequestEvidenceInventoryListgetByCon(Map jsonMap) async {
    //encode Map to JSON
    var body = json.encode(jsonMap);
    final response = await http.post(
      serv
          .Server()
          .IPAddressEvidenceOut + "/EvidenceInventoryListgetByCon",
      headers: {"Content-Type": "application/json"},
      body: body,
    );
    if (response.statusCode == 200) {
      List responseJson = json.decode(response.body);
      return responseJson.map((m) => new EvidenceInventory.fromJson(m))
          .toList();
    } else {
      print('Something went wrong. \nResponse Code : ${response.statusCode}');
    }
