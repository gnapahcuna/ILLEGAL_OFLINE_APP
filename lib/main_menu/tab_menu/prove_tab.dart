              ...
              Column(
                ...
                children: <Widget>[
                  ...
                  Padding(
                    padding: paddingData,
                    child: Text(
                      itemMain[index].LAWSUIT_NO.toString()+"/"+_convertYear(itemMain[index].LAWSUIT_NO_YEAR),
                      style: textStyleData,),
                  ),
                  Container(
                    padding: paddingLabel,
                    child: Text("ผู้รับคดี", style: textStyleLabel,),
                  ),
                  Padding(
                    padding: paddingData,
                    child: Text(
                        ...
                        child: Container(
                            ...
                            child: Center(
                              child: MaterialButton(
                                onPressed: () {
                                  _navigate(
                                      context,itemMain[index].LAWSUIT_ID);
                                },
      ...
      builder: (context, snapshot) {
        if (snapshot.hasData) {
          ...
          snapshot.data.forEach((item){
            if(item.PROVE_ID==0||item.PROVE_ID==null){
              items.add(item);
            }
          });
          itemMain = items;*/
                            ...
                            child: Container(
                              ...
                              child: Row(
                                ...
                                children: <Widget>[
                                  Container(
                                    padding: paddingLabel,
                                    child: Text('รอพิสูจน์ '+itemMain.length.toString()+' คดี',style: textStyleLabel,),
                                  )
                                ],
                              ),
                            )
                        ...
                        new Center(
                            child: new Container(
                              child: new Column(
                                ...
                                children: <Widget>[
                                  Text(
                                    "ไม่มีรายการพิสูจน์ของกลาง", style: TextStyle(
                                      fontSize: 20.0,
