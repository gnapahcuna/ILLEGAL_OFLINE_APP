...
class _FragmentState extends State<TrackingFragment> {
  ...
  TextStyle textStyleSubLabel = TextStyle(
      fontSize: 16,
  ...
  Widget _buildContent(BuildContext context) {
    Map map = {
      ...
      "DISTRINCE": null,
      "SUBDISTRINCE": null,
      "ARREST_LAWBREAKER_NAME": "",
      "ARREST_STAFF_NAME": "",
      "SUBSECTION_NAME": null,
      "PRODUCT_GROUP_NAME": null,
      "LAWSUIT_NO": null,
      "LAWSUIT_NO_YEAR": "",
      "LAWSUIT_STAFF_NAME": null,
      "LAWSUIT_DATE_FROM": null,
      "LAWSUIT_DATE_TO": null,
      "LAWSUIT_OFFICE_NAME": null,
      "PROVE_NO": null,
      "PROVE_NO_YEAR": null,
      "PROVE_STAFF_NAME": "  ",
      "PROVE_DATE_FROM": null,
      "PROVE_DATE_TO": null,
      "COMPARE_NO": null,
      "COMPARE_STAFF_NAME": "  ",
    ...
    return FutureBuilder<ItemsTrackingCaseByKeyword>(
      ...
      builder: (context, snapshot) {
        if (snapshot.hasData) {
          _itemMains = snapshot.data.CaseStatusList;
          List<String> head = [];
          ...
          for (int index = 0; index < _itemMains.length; index++) {
            if (_itemMains[index].CASE_STATUS == "รอรับคดี") {
              itemHeadList_1.add(new ItemsTrackingHeadList(
                  _itemMains[index].ARREST_ID,
                  _itemMains[index].ARREST_CODE,
                  _itemMains[index].ARREST_STAFF_NAME, [
                new ItemsTrackingArrestList(1,
                    _itemMains[index].ARREST_CODE,
                    _itemMains[index].OCCURRENCE_DATE.toString(), [
                      new ItemsTrackingSubDetail(
                          _itemMains[index].LAWSUIT_STAFF_NAME)
                    ])
              ]));
            }else if (_itemMains[index].CASE_STATUS == "ไม่รับเป็นคดี") {
              itemHeadList_1_2.add(new ItemsTrackingHeadList(
                  _itemMains[index].ARREST_ID,
                  _itemMains[index].ARREST_CODE,
                  _itemMains[index].ARREST_STAFF_NAME, [
                new ItemsTrackingArrestList(1,
              ...
              itemHeadList_2.add(new ItemsTrackingHeadList(
                  _itemMains[index].ARREST_ID,
                  _itemMains[index].LAWSUIT_NO,
                  law_name, [
                new ItemsTrackingArrestList(2, _itemMains[index].ARREST_CODE,
                    _itemMains[index].OCCURRENCE_DATE.toString(), [
                  new ItemsTrackingSubDetail(
                      _itemMains[index].LAWSUIT_STAFF_NAME)
                ])
              ...
              itemHeadList_3.add(new ItemsTrackingHeadList(
                  _itemMains[index].ARREST_ID,
                  _itemMains[index].LAWSUIT_NO.toString(),
                  law_name, [
                new ItemsTrackingArrestList(1, _itemMains[index].ARREST_CODE,
                    _itemMains[index].OCCURRENCE_DATE.toString(), [
                  new ItemsTrackingSubDetail(
                      _itemMains[index].ARREST_STAFF_NAME),
                  new ItemsTrackingSubDetail(
                ...
                new ItemsTrackingLawsuitList(
                    ...
                    _itemMains[index].ARREST_CODE,
                    _itemMains[index].OCCURRENCE_DATE.toString(),
                    _itemMains[index].LAWSUIT_STAFF_NAME.toString(), [
                  new ItemsTrackingSubDetail(
                      _itemMains[index].PROVE_STAFF_NAME),
                  new ItemsTrackingSubDetail(
                      _itemMains[index].COMPARE_STAFF_NAME)
                ]),
              ]));
            } else if (_itemMains[index].CASE_STATUS ==
                    "รอเปรียบเทียบคดีและชำระค่าปรับ" ||
                _itemMains[index].CASE_STATUS == "รอเปรียบเทียบและชำระเงิน") {
              String law_name = "";
              _itemMains[index].LawbreakerList.forEach((law){
                law_name += law.ARREST_LAWBREAKER_NAME+"\n";
              });
              ...
              itemHeadList_4.add(new ItemsTrackingHeadList(
                  _itemMains[index].ARREST_ID,
                  _itemMains[index].LAWSUIT_NO.toString(),
                  law_name, [
                new ItemsTrackingArrestList(1, _itemMains[index].ARREST_CODE,
              ...
              itemHeadList_5.add(new ItemsTrackingHeadList(
                  _itemMains[index].ARREST_ID,
                  _itemMains[index].LAWSUIT_NO.toString(),
                  law_name, [
                new ItemsTrackingArrestList(1, _itemMains[index].ARREST_CODE,
            ...
            } else if (_itemMains[index].CASE_STATUS == "รอแบ่งเงินสินบน" ||
                _itemMains[index].CASE_STATUS == "รอแบ่งเงินสินบนรางวัล") {
              String law_name = "";
              _itemMains[index].LawbreakerList.forEach((law){
                law_name += law.ARREST_LAWBREAKER_NAME+"\n";
              });

              itemHeadList_6.add(new ItemsTrackingHeadList(
                  _itemMains[index].ARREST_ID,
                  _itemMains[index].LAWSUIT_NO.toString(),
                  law_name, [
                new ItemsTrackingArrestList(1, _itemMains[index].ARREST_CODE,
              ...
              itemHeadList_7.add(new ItemsTrackingHeadList(
                  _itemMains[index].ARREST_ID,
                  _itemMains[index].LAWSUIT_NO.toString(),
                  law_name, [
                new ItemsTrackingArrestList(1, _itemMains[index].ARREST_CODE,
              ...
              itemHeadList_8.add(new ItemsTrackingHeadList(
                  _itemMains[index].ARREST_ID,
                  _itemMains[index].LAWSUIT_NO.toString(),
                  law_name, [
                new ItemsTrackingArrestList(1, _itemMains[index].ARREST_CODE,
              ...
              itemHeadList_9.add(new ItemsTrackingHeadList(
                  _itemMains[index].ARREST_ID,
                  _itemMains[index].LAWSUIT_NO.toString(),
                  law_name, [
                new ItemsTrackingArrestList(1, _itemMains[index].ARREST_CODE,
          ...
          itemMain = [
            ...
            new ItemsTrackingMain(
                4, "รอเปรียบเทียบคดีและชำระค่าปรับ", itemHeadList_4),
            new ItemsTrackingMain(5, "รอนำส่งรายได้", itemHeadList_5),
            new ItemsTrackingMain(6, "รอแบ่งเงินสินบน", itemHeadList_6),
            new ItemsTrackingMain(7, "รอแบ่งเงินสินบนรางวัล", itemHeadList_7),
                    ...
                    return GestureDetector(
                      ...
                      child: Padding(
                        padding: const EdgeInsets.only(
                            left: 22.0, right: 22.0, top: 2.0, bottom: 2.0),
                          ...
                          Container(
                            ...
                            child: Text(
                              ' วันที่ ' +
                                  ...
                                  " " +
                                  _convertTime(DateTime.now().toString()),
