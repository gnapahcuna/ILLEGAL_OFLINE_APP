...
class _FragmentState extends State<CheckEvidenceFragment>with TickerProviderStateMixin {
  ...
  TextStyle textStyleFloatingBtn = TextStyle(color: Colors.black,
      fontFamily: FontStyles().FontFamily,
      fontSize: 16.0);

  TextStyle textStyleAdd = TextStyle(
  ...
  Widget _buildContent(BuildContext context) {
    return ListView.builder(
      ...
      itemBuilder: (BuildContext context, int index) {
        String person, textButton, staff_name;
        ...
        itemMain[index].EvidenceInStaff.forEach((item) {
          staff_name =
              item.TITLE_SHORT_NAME_TH.toString() + item.FIRST_NAME + " " +
                  item.LAST_NAME;
        });
              ...
              Column(
                ...
                children: <Widget>[
                  Container(
                    ...
                    child: Text(itemMain[index].EVIDENCE_IN_TYPE == 2
                        ? "เลขที่หนังสือ"
  ...
  Future<bool> onLoadAction(ItemsEvidenceList itemsMain) async {
    ...
    map = {
      "LAWSUIT_ID": itemsEvidenceArrest.LAWSUIT_ID
    };
  ...
  _navigate(BuildContext context, ItemsEvidenceList itemsMain,
      String title) async {
    showDialog(
        ...
        new MaterialPageRoute(
            builder: (context) =>
                CheckEvidenceMainScreenFragment(
                  ...
                  itemsMasProductUnit: widget
                      .itemsMasProductUnit,
                  itemsMasProductSize: widget
                      .itemsMasProductSize,
                  itemsMasWarehouse: widget.itemsMasWarehouse,
                )));
  }
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<List<ItemsEvidenceList>>(
      future: new CheckEvidenceFuture().apiRequestEvidenceInListgetByConAdv(
          map),
