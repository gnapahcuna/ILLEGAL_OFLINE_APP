...
class _FragmentState extends State<CompareMainScreenFragmentSearchResult> {
            ...
            child: Stack(children: <Widget>[
              _searchResult[index].COMPARE_ID != 0 ? Column(
                ...
                children: <Widget>[
                  ...
                  Container(
                    padding: paddingInputBox,
                    child: Text(_searchResult[index].COMPARE_TITLE_SHORT_NAME_TH.toString()+
                        _searchResult[index].COMPARE_FIRST_NAME.toString()+" "+
                        _searchResult[index].COMPARE_LAST_NAME.toString(), style: textInputStyle,),
                  ),
                ],
              )
                  : Column(
                ...
                children: <Widget>[
                  ...
                  Container(
                    padding: paddingInputBox,
                    child: Text(_searchResult[index].LAWSUIT_TITLE_SHORT_NAME_TH.toString()+
                        _searchResult[index].LAWSUIT_FIRST_NAME+" "+
                        _searchResult[index].LAWSUIT_LAST_NAME, style: textInputStyle,),
                  ),
                ],
              ),
                            ...
                            child: Container(
                                ...
                                child: Center(
                                  child: MaterialButton(
                                    onPressed: () {
                                      _navigatePreview(
                                        context, _searchResult[index].INDICTMENT_ID, _searchResult[index].COMPARE_ID,index);
                                    },
  ...
  _navigatePreview(BuildContext context,int INDICTMENT_ID,COMPARE_ID,index) async {
    showDialog(
