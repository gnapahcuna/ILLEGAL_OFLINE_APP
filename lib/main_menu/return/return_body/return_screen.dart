    ...
    await new TransectionFuture()
      ...
      if (_itemTransection.length != 0) {
        ...
        String date_auto = (int.parse(
            ...
            .substring(2);
        transection_no =
            "RT" + widget.ItemsPerson.WorkOffCode + date_auto + "00001";
      }
    });
                            ...
                            itemMain.EVIDENCE_OUT_TYPE == 0
                              ...
                              children: <Widget>[
                                ...
                                Container(
                                  padding: paddingLabel,
                                  child: Text(
                                    _convertDate(itemMain.PAY_DATE) +
                                        " " +
                                        _convertTime1(itemMain.PAY_DATE),
                                    style: textInputStyle,
                                  ),
                                ),
                                Padding(
                                ...
                                Container(
                                  padding: paddingLabel,
                                  child: Text(
                                    get_staff_name(itemMain.EvidenceOutStaff, 67)!=null
                                        ?get_staff_name(itemMain.EvidenceOutStaff, 67)
                                        :"",
                                    style: textInputStyle,
                                  ),
                                ),
                                ...
                                Container(
                                  padding: paddingLabel,
                                  child: Text(
                                    get_office_name(itemMain.EvidenceOutStaff, 67)!=null
                                        ?get_office_name(itemMain.EvidenceOutStaff, 67)
                                        :"",
                                    style: textInputStyle,
                                  ),
                                ),
                              ...
                              children: <Widget>[
                                ...
                                Container(
                                  padding: paddingLabel,
                                  child: Text(
                                    get_staff_name(itemMain.EvidenceOutStaff, 64)!=null
                                        ?get_staff_name(itemMain.EvidenceOutStaff, 64)
                                        :"",
                                    style: textInputStyle,
                                  ),
                                ),
                                ...
                                Padding(
                                  padding: paddingInputBox,
                                  child: Text(
                                    get_pos_name(itemMain.EvidenceOutStaff, 64)!=null
                                        ?get_pos_name(itemMain.EvidenceOutStaff, 64)
                                        :"",
                                    style: textInputStyle,
                                  ),
                                ),
                                ...
                                Container(
                                  padding: paddingLabel,
                                  child: Text(
                                    get_office_name(itemMain.EvidenceOutStaff, 64)!=null
                                        ?get_office_name(itemMain.EvidenceOutStaff, 64)
                                        :"",
                                    style: textInputStyle,
                                  ),
                                ),
  ...
  Widget _buildContent_tab_2() {
    Widget _buildExpandableContent(int index) {
      ...
      Widget _buildExpanded(index) {
        itemEvidence[index].ItemsController.editDeliveredNumber.text =
            "22";
        itemEvidence[index].ItemsController.editTotalNumber.text =
            "22";
        itemEvidence[index].ItemsController.editDeliveredVolumn.text =
            "500";
        itemEvidence[index].ItemsController.editTotalVolumn.text =
            "500";
        itemEvidence[index].ItemsController.editTotalNumberUnit.text =
            "ขวด";
        itemEvidence[index].ItemsController.editTotalVolumnUnit.text =
            "ลิตร";
        return Stack(
          children: <Widget>[
            Column(
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  Padding(
                    padding: paddingInputBox,
                    child: Text(
                      get_staff_name(itemMain.EvidenceOutStaff, 65)!=null
                          ?get_staff_name(itemMain.EvidenceOutStaff, 65)
                          :"",
                      style: textInputStyle,
                    ),
                  ),
                  ...
                  Padding(
                    padding: paddingInputBox,
                    child: Text(
                      get_office_name(itemMain.EvidenceOutStaff, 65)!=null
                          ?get_office_name(itemMain.EvidenceOutStaff, 65)
                          :"",
                      style: textInputStyle,
                    ),
                  ),
