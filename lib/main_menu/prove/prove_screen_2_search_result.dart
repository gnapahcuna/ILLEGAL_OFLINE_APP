...
class _FragmentState extends State<ProveMainScreenFragmentSearchResult> {
                  ...
                  _searchResult[index].PROVE_ID == null
                      ...
                      Padding(
                        ...
                        child: Text(
                          _searchResult[index].LAWSUIT_NO.toString() + '/' +
                              _searchResult[index].LAWSUIT_NO_YEAR.toString(), style: textInputStyle,),
                      ),
                      Container(
                        padding: paddingLabel,
                        child: Text("ประเภทของกลาง", style: textLabelStyle,),
                      ),
                      Padding(
                        padding: paddingInputBox,
                        child: Text(
                    ...
                    children: <Widget>[
                      ...
                      Container(
                        padding: paddingLabel,
                        child: Text(
                          "ผู้ตรวจพิสูจน์", style: textLabelStyle,),
                      ),
                      Padding(
                        padding: paddingInputBox,
                        child: Text(
                          _searchResult[index].PROVE_STAFF_NAME.trim().isEmpty
                              ?""
                              :_searchResult[index].PROVE_STAFF_NAME,
                          style: textInputStyle,),
                      ),
                    ],
                  ),
                            ...
                            child: Container(
                                ...
                                child: Center(
                                  child: MaterialButton(
                                    onPressed: () {
                                      _navigate(context,_searchResult[index].LAWSUIT_ID
                                          ,_searchResult[index].PROVE_ID,false,true,false,index);
                                    },
  ...
  Future<bool> onLoadAction(Map map,bool IsPreview,int proveID) async {
