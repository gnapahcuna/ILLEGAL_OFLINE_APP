...
class _FragmentState extends State<ProveMainScreenFragmentSearch2> {
  ...
  Future<bool> onLoadAction(Map map) async {
    await new ProveFuture().apiRequestProveListgetByConAdv(map).then((
        onValue) {
                            ...
                            child: MaterialButton(
                              onPressed: () {
                                ...
                                Map map = {
                                  ...
                                  "PROVE_IS_OUTSIDE": IsOutside?1:0,
      ...
      child: new Column(
        ...
        children: <Widget>[
          Container(
            ...
            child: Text("ลักษณะการพิสูจน์", style: textLabelStyle,),
          ),
          ...
          Container(
            //padding: paddingLabel,
            child: Text("สถานะการพิสูจน์", style: textLabelStyle,),
          ),
          SingleChildScrollView(
            scrollDirection: Axis.horizontal,
            child: Row(
                    ...
                    children: <Widget>[
                      InkWell(
                        ...
                        child: Container(
                          decoration: BoxDecoration(
                            shape: BoxShape.circle,
                            color: IsProveComplete ? Color(0xff3b69f3) : Colors
                                .white,
                            border: Border.all(color: Colors.black12),
                          ),
                          child: Padding(
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    Container(
                      padding: paddingLabel,
                      child: Text("วันที่พิสูจน์", style: textLabelStyle,),
                    ),
                    Padding(
                      padding: paddingInputBox,
                      child: TextField(
          ...
          Container(
            padding: paddingLabel,
            child: Text("ชื่อผู้พิสูจน์", style: textLabelStyle,),
          ),
          Padding(
            padding: paddingInputBox,
            child: TextField(
  ...
  Widget build(BuildContext context) {
    ...
    return new WillPopScope(
      ...
      appBar: PreferredSize(
        ...
        child: AppBar(
          title: new Text("ค้นหางานพิสูจน์ของกลาง",
