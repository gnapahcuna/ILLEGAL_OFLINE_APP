...
import 'package:prototype_app_pang/main_menu/prove/prove_remark_screen.dart';
...
class _FragmentState extends State<ProveMainScreenFragment>
  ...
  TextEditingController editCheckEvidencePersonName =
  ...
  TextStyle appBarStylePay = TextStyle(
      fontSize: 16.0, color: Colors.white, fontFamily: FontStyles().FontFamily);
  ...
  void initState() {
    ...
    _currentProveEvidenceTime =
        dateFormatTime.format(DateTime.now()).toString();
  ...
  void _setInitDataProve() {
    ...
    itemsProveStaff.forEach((item){
      if(item.CONTRIBUTOR_ID==22){
        editCheckEvidencePersonName.text = item.TITLE_SHORT_NAME_TH.toString()+
      item.FIRST_NAME+" "+item.LAST_NAME;
      }else if(item.CONTRIBUTOR_ID==25){
        editProvePerson.text = item.TITLE_SHORT_NAME_TH.toString()+
            item.FIRST_NAME+" "+item.LAST_NAME;
      }else if(item.CONTRIBUTOR_ID==26){
        editDeriveredPersonName.text = item.TITLE_SHORT_NAME_TH.toString()+
            item.FIRST_NAME+" "+item.LAST_NAME;
      }
    });
  }
  ...
  void _setDataSaved() {
    ...
    print("tab : "+tabController.length.toString());
  }
  ...
  Future<bool> onLoadActionProveinsAll(Map map) async {
    ...
    List<Map> map_staff = [
      _createMapStaff(PROVE_ID, 22,null),
      _createMapStaff(PROVE_ID, 25,null),
      _createMapStaff(PROVE_ID, 26,null)
    ];
    for (int i = 0; i < map_staff.length; i++) {
      await new ProveFuture()
          .apiRequestProveStaffinsAll(map_staff[i])
          .then((onValue) {
    ...
    if (IsProve) {
      ...
      await new ProveFuture()
          .apiRequestProveScienceinsAll(map_science)
          .then((onValue) {
    ...
    for(int i=0;i<_createMapProduct(PROVE_ID,SCIENCE_ID).length;i++){
      await new ProveFuture()
          .apiRequestProveProductinsAll(_createMapProduct(PROVE_ID,SCIENCE_ID)[i])
          .then((onValue) {
    ...
    await new ProveFuture()
        .apiRequestProveStaffgetByCon(map_prove_id)
        .then((onValue) {
      itemsProveStaff = onValue;
    });
    await new ProveFuture()
        .apiRequestProveSciencegetByCon(map_prove_id)
        .then((onValue) {
      if (onValue.length > 0) {
    ...
    await new ProveFuture()
        .apiRequestProveProductgetByProveId(map_prove_id)
        .then((onValue) {
    ...
    map = {
      "ProveID":itemsProveMain.PROVE_ID
    };
  ...
  void onSaved(BuildContext mContext) async {
    ...
    if(_onEdited){
      ...
      for (int i = 0; i < itemsProveArrestProduct.length; i++) {
        ...
        if (double.parse(
            itemsProveArrestProduct[i].controller.editQuantity.text.replaceAll(",","")) >
            itemsProveArrestProduct[i].QUANTITY
            || double.parse(
                itemsProveArrestProduct[i].controller.editVolume.text.replaceAll(",","")) >
                itemsProveArrestProduct[i].VOLUMN) {
    ...
    if (editCheckEvidenceNumber.text.isEmpty) {
    ...
    }else if (PROVE_RESULT==null||PROVE_RESULT.isEmpty) {
      new VerifyDialog(mContext, 'กรุณาสรุปผลรายงานการพิสูจน์ก่อน');
      ...
      if(!_onEdited){
        Map map_prove = {
          ...
          "LAWSUIT_NO_YEAR": /*itemsProveArrest.LAWSUIT_NO_YEAR*/ DateTime.now()
              .toString(),
        ...
        Map map_prove = {
          ...
          "DELIVERY_PROVE_DOC_NO_1": "",
          "DELIVERY_PROVE_DOC_NO_2": "",
          "PROVE_RESULT": itemsProveMain.PROVE_RESULT,
          "IS_ACTIVE": "1"
        };
    ...
    if(_onEdited){
      itemsProveProduct.forEach((item) {
        ...
        map.add({
          ...
          "PRODUCT_GROUP_CODE": item.PRODUCT_GROUP_CODE == null ? "" : item
              .PRODUCT_GROUP_CODE,
          "PRODUCT_GROUP_NAME": item.PRODUCT_GROUP_NAME == null ? "" : item
              .PRODUCT_GROUP_NAME,
          "PRODUCT_CATEGORY_CODE": item.PRODUCT_CATEGORY_CODE == null
              ? ""
              : item.PRODUCT_CATEGORY_CODE,
          "PRODUCT_CATEGORY_NAME": item.PRODUCT_CATEGORY_NAME == null
              ? ""
              : item.PRODUCT_CATEGORY_NAME,
          "PRODUCT_TYPE_CODE": item.PRODUCT_TYPE_CODE == null ? "" : item
              .PRODUCT_TYPE_CODE,
          "PRODUCT_TYPE_NAME": item.PRODUCT_TYPE_NAME == null ? "" : item
              .PRODUCT_TYPE_NAME,
          "PRODUCT_SUBTYPE_CODE": item.PRODUCT_SUBTYPE_CODE == null ? "" : item
              .PRODUCT_SUBTYPE_CODE,
          "PRODUCT_SUBTYPE_NAME": item.PRODUCT_SUBTYPE_NAME == null ? "" : item
              .PRODUCT_SUBTYPE_NAME,
          "PRODUCT_SUBSETTYPE_CODE": item.PRODUCT_SUBSETTYPE_CODE == null
              ? ""
              : item.PRODUCT_SUBSETTYPE_CODE,
          "PRODUCT_SUBSETTYPE_NAME": item.PRODUCT_SUBSETTYPE_NAME == null
              ? ""
              : item.PRODUCT_SUBSETTYPE_NAME,
          "PRODUCT_BRAND_CODE": item.PRODUCT_BRAND_CODE == null ? "" : item
              .PRODUCT_BRAND_CODE,
          "PRODUCT_BRAND_NAME_TH": item.PRODUCT_BRAND_NAME_TH == null
              ? ""
              : item.PRODUCT_BRAND_NAME_TH,
          "PRODUCT_BRAND_NAME_EN": item.PRODUCT_BRAND_NAME_EN == null
              ? ""
              : item.PRODUCT_BRAND_NAME_EN,
          "PRODUCT_SUBBRAND_CODE": item.PRODUCT_SUBBRAND_CODE == null
              ? ""
              : item.PRODUCT_SUBBRAND_CODE,
          "PRODUCT_SUBBRAND_NAME_TH": item.PRODUCT_SUBBRAND_NAME_TH == null
              ? ""
              : item.PRODUCT_SUBBRAND_NAME_TH,
          "PRODUCT_SUBBRAND_NAME_EN": item.PRODUCT_SUBBRAND_NAME_EN == null
              ? ""
              : item.PRODUCT_SUBBRAND_NAME_EN,
          "PRODUCT_MODEL_CODE": item.PRODUCT_MODEL_CODE == null ? "" : item
              .PRODUCT_MODEL_CODE,
          "PRODUCT_MODEL_NAME_TH": item.PRODUCT_MODEL_NAME_TH == null
              ? ""
              : item.PRODUCT_MODEL_NAME_TH,
          "PRODUCT_MODEL_NAME_EN": item.PRODUCT_MODEL_NAME_EN == null
              ? ""
  ...
  Widget build(BuildContext context) {
    ...
    final List<Widget> rowContents = <Widget>[
      ...
      Expanded(
          child: Center(
        child: Text("พิสูจน์ของกลาง", style: appBarStyle),
      )),
      new SizedBox(
          width: width / 3,
          child: new Row(
                          ...
                          ? new ButtonTheme(
                              ...
                              child: FlatButton(
                                onPressed: () {
                                  //เมื่อชำระค่าปรับ
                                  _navigate_compare(
                                      context, itemsProveArrest.INDICTMENT_ID);
                                },
                                child: Row(
                                  children: <Widget>[
    ...
    return Column(
      ...
      children: <Widget>[
        ...
        Padding(
          padding: paddingData,
          child: Text(
            itemsProveArrest.LAWSUIT_NO +
                "/" +
                (int.parse(itemsProveArrest.LAWSUIT_NO_YEAR) + 543).toString(),
            style: textStyleData,
          ),
        ),
        Padding(
        ...
        Padding(
          padding: paddingData,
          child: Text(
            _convertDate(itemsProveArrest.ARREST_DATE) +
                " " +
                _convertTime(itemsProveArrest.ARREST_DATE),
            style: textStyleData,
          ),
        ),
        Container(
        ...
        Padding(
          padding: paddingData,
          child: Text(
            itemsProveArrest.GROUP_SECTION_SECTION_ID.toString(),
            style: textStyleData,
          ),
        ),
        Container(
        ...
        Padding(
          padding: paddingData,
          child: Text(
            itemsProveArrest.GUILTBASE_NAME,
            style: textStyleData,
          ),
        ),
        Container(
        ...
        Padding(
          ...
          child: Text(
            _convertDate(itemsProveArrest.LAWSUIT_DATE) +
                " " +
                _convertTime(itemsProveArrest.LAWSUIT_DATE),
            style: textStyleData,
          ),
        ),
      ],
      ...
      children: <Widget>[
        ...
        Padding(
          ...
          child: Text(
            itemsProveArrest.LAWSUIT_NO +
                "/" +
                itemsProveArrest.LAWSUIT_NO_YEAR,
            style: textStyleData,
          ),
        ),
        Padding(
                    ...
                    itemBuilder: (BuildContext context, int index) {
                      return Column(
                        ...
                        children: <Widget>[
                          InkWell(
                            onTap: () {
                              _navigateProveArrestProduct(context,
                                  itemsProveArrestProduct[index]);
                            },
                            child: Row(
                                ...
                                Expanded(
                                  child: Container(
                                    ...
                                    child: Text(
                                      (index + 1).toString() +
                                          ". " +
                                          (itemsProveArrestProduct[index].PRODUCT_GROUP_NAME != null
                                              ? (itemsProveArrestProduct[index].PRODUCT_GROUP_NAME
                                              .toString() + ' ')
                                              : '') +
                                          (itemsProveArrestProduct[index].PRODUCT_CATEGORY_NAME != null
                                              ? (itemsProveArrestProduct[index].PRODUCT_CATEGORY_NAME
                                              .toString() + ' ')
                                              : '') +
                                          (itemsProveArrestProduct[index].PRODUCT_TYPE_NAME != null
                                              ? (itemsProveArrestProduct[index].PRODUCT_TYPE_NAME
                                              .toString() + ' ')
                                              : '') +
                                          (itemsProveArrestProduct[index].PRODUCT_BRAND_NAME_TH != null
                                              ? (itemsProveArrestProduct[index].PRODUCT_BRAND_NAME_TH
                                              .toString() + ' ')
                                              : '') +
                                          (itemsProveArrestProduct[index].PRODUCT_BRAND_NAME_EN != null
                                              ? (itemsProveArrestProduct[index].PRODUCT_BRAND_NAME_EN
                                              .toString() + ' ')
                                              : '') +
                                          (itemsProveArrestProduct[index].PRODUCT_SUBBRAND_NAME_TH != null
                                              ? (itemsProveArrestProduct[index].PRODUCT_SUBBRAND_NAME_TH
                                              .toString() + ' ')
                                              : '') +
                                          (itemsProveArrestProduct[index].PRODUCT_SUBBRAND_NAME_EN != null
                                              ? (itemsProveArrestProduct[index].PRODUCT_SUBBRAND_NAME_EN
                                              .toString() + ' ')
                                              : '') +
                                          (itemsProveArrestProduct[index].PRODUCT_MODEL_NAME_TH != null
                                              ? (itemsProveArrestProduct[index].PRODUCT_MODEL_NAME_TH
                                              .toString() + ' ')
                                              : '') +
                                          (itemsProveArrestProduct[index].PRODUCT_MODEL_NAME_EN != null
                                              ? (itemsProveArrestProduct[index].PRODUCT_MODEL_NAME_EN
                                              .toString() + ' ')
                                              : '')+
                                          (itemsProveArrestProduct[index].PRODUCT_SUBBRAND_NAME_TH != null
                                              ? (itemsProveArrestProduct[index].PRODUCT_SUBBRAND_NAME_TH
...
//************************end_tab_2*******************************
  Widget _buildContent_tab_2() {
                                    ...
                                    child: Column(
                                      ...
                                      children: <Widget>[
                                        new Container(
                                          ...
                                          child: TextField(
                                            focusNode:
                                                myFocusNodeCheckEvidenceNumber,
                                        ...
                                        CupertinoDatePicker(
                                          ...
                                          onDateTimeChanged:
                                            ...
                                            setState(() {
                                              ...
                                              _currentProveTime = dateFormatTime
                                                  .format(checkEvidenceTime)
                                                  .toString();
                                              editCheckEvidenceTime.text =
                                                  _currentProveTime;
                                ...
                                children: <Widget>[
                                  new Container(
                                    ...
                                    child: TextField(
                                      enabled: false,
                                      focusNode:
                                          myFocusNodeCheckEvidencePersonName,
    ...
    Widget _buildContent_saved(BuildContext context) {
      ...
      itemsProveStaff.forEach((item) {
        if (item.CONTRIBUTOR_ID == 22) {
          staff_name = item.TITLE_SHORT_NAME_TH.toString() +
              item.FIRST_NAME +
              " " +
              item.LAST_NAME;
        }
                  ...
                  Column(
                    ...
                    children: <Widget>[
                      ...
                      Row(
                        ...
                        children: <Widget>[
                          Padding(
                            padding: paddingData,
                            child: Text(
                              itemsProveMain.PROVE_NO.toString() +
                                  '/' +
                                  itemsProveMain.PROVE_NO_YEAR.toString(),
                              style: textStyleData,
                            ),
                          ),
                        ],
                      ...
                      Padding(
                        padding: paddingData,
                        child: Text(
                          _convertDate(itemsProveMain.RECEIVE_DOC_DATE) +
                              ' ' +
                              _convertTime(itemsProveMain.RECEIVE_DOC_DATE),
                          style: textStyleData,
                        ),
                      ),
                      Container(
...
//************************end_tab_2*******************************
  ...
  //************************start_tab_3*******************************
  String PROVE_RESULT;
  _navigateProveResult(BuildContext context,bool IsCreate,bool IsPreview)async{
    var result;
    if(IsPreview||PROVE_RESULT!=null){
     ...
     result = await Navigator.push(
        context,
        MaterialPageRoute(
            builder: (context) => ProveRemarkScreenFragment(
              PROVE_RESULT: PROVE_RESULT,
              IsCreate: false,
              IsPreview: true,
              itemsProveMain: itemsProveMain,
    ...
    if(result!="Back"){
      if(_onSaved){
        itemsProveMain.PROVE_RESULT = result;
      }
      PROVE_RESULT = result;
    }
  }
  ...
  Future<bool> onLoadActionDocument(ItemsProveProduct itemProduct) async {
    Map map = {
      "DOCUMENT_TYPE": 5,
      "REFERENCE_CODE": itemProduct.PRODUCT_ID
    };
                  ...
                  return GestureDetector(
                    ...
                    child: Column(
                      ...
                      children: <Widget>[
                          ...
                          child: Row(
                            ...
                            children: <Widget>[
                              Container(
                                padding: paddingData,
                                child: Text(
                                  itemsProveArrestProduct[j].VAT.toString() +
                                      " บาท",
                                  style: textStyleData,
                                ),
                              )
                        ...
                        _calTaxTotal(
                            itemsProveArrestProduct[j].VAT,
                            j, itemsProveArrestProduct.length)
                      ],
                    ),
                  ),
                  );
                  ...
                  return Container(
                    ...
                    child: Column(
                      ...
                      children: <Widget>[
                            ...
                            children: <Widget>[
                              Container(
                                ...
                                child: Text(
                                  (j + 1).toString() +
                                      ". " +
                                      (itemsProveProduct[j].PRODUCT_GROUP_NAME != null
                                          ? (itemsProveProduct[j].PRODUCT_GROUP_NAME
                                          .toString() + ' ')
                                          : '') +
                                      (itemsProveProduct[j].PRODUCT_CATEGORY_NAME != null
                                          ? (itemsProveProduct[j].PRODUCT_CATEGORY_NAME
                                          .toString() + ' ')
                                          : '') +
                                      (itemsProveProduct[j].PRODUCT_TYPE_NAME != null
                                          ? (itemsProveProduct[j].PRODUCT_TYPE_NAME
                                          .toString() + ' ')
                                          : '') +
                                      (itemsProveProduct[j].PRODUCT_BRAND_NAME_TH != null
                                          ? (itemsProveProduct[j].PRODUCT_BRAND_NAME_TH
                                          .toString() + ' ')
                                          : '')/* +
                                      (itemsProveProduct[j].PRODUCT_BRAND_NAME_EN != null
                                          ? (itemsProveProduct[j].PRODUCT_BRAND_NAME_EN
                                          .toString() + ' ')
                                          : '')+
                                      (itemsProveProduct[j].PRODUCT_SUBBRAND_NAME_TH != null
                                          ? (itemsProveProduct[j].PRODUCT_SUBBRAND_NAME_TH
                                          .toString() + ' ')
                                          : '') +
                                      (itemsProveProduct[j].PRODUCT_SUBBRAND_NAME_EN != null
                                          ? (itemsProveProduct[j].PRODUCT_SUBBRAND_NAME_EN
                                          .toString() + ' ')
                                          : '') +
                                      (itemsProveProduct[j].PRODUCT_MODEL_NAME_TH != null
                                          ? (itemsProveProduct[j].PRODUCT_MODEL_NAME_TH
                                          .toString() + ' ')
                                          : '') +
                                      (itemsProveProduct[j].PRODUCT_MODEL_NAME_EN != null
                                          ? (itemsProveProduct[j].PRODUCT_MODEL_NAME_EN
                                          .toString() + ' ')
                                          : '')*/,
                                  style: textStyleLabel,
                                ),
                        ...
                        _calTaxTotal(
                            itemsProveProduct[j].VAT == null
                                ? 0
                                : itemsProveProduct[j].VAT,
                            j,
                            itemsProveProduct.length),
                        Padding(
                          padding: paddingData,
                          child: Container(
                            height: 1.0,
            ...
            child: Row(
              ...
              children: <Widget>[
                ...
                Container(
                  padding: paddingData,
                  child: Text(
                    formatter.format(taxTotal).toString() + " บาท",
                    style: textStyleData,
                  ),
                ),
              ],
            ...
            child: Column(
              children: <Widget>[
                                  ...
                                  CupertinoDatePicker(
                                    ...
                                    onDateTimeChanged: (DateTime newDateTime) {
                                      setState(() {
                                        ...
                                        _currentProveEvidenceTime =
                                            dateFormatTime
                                                .format(proveEvidenceTime)
                                                .toString();
                                        editProveEvidenceTime.text =
                                            _currentProveEvidenceTime;

                                        List splitsArrestDate = _dtProve
                                            .toUtc()
                                            .toLocal()
                                            .toString()
                                            .split(" ");
                                        List splitsArrestTime =
                                        proveEvidenceTime.toString().split(" ");
                                        _proveEvidenceDate =
                                        ...
                                        onDateTimeChanged:
                                          ...
                                          setState(() {
                                            ...
                                            deliverTime
                                                .toString()
                                                .split(" ");
                                            _deliverDate = splitsArrestDate[0]
                                                .toString() +
                                                " " +
                                                splitsArrestTime[1]
                                                    .toString();
                ...
                _onEdited
                    ...
                    : _buildTaxValueProduct(context, size),
              ...
              children: <Widget>[
                        ...
                        Column(
                          ...
                          children: <Widget>[
                            ...
                            Row(
                              ...
                              children: <Widget>[
                                Padding(
                                  padding: paddingData,
                                  child: Text(
                                    _convertDate(itemsProveMain.PROVE_DATE) +
                                        ' ' +
                                        _convertTime(itemsProveMain.PROVE_DATE),
                                    style: textStyleData,
                                  ),
                                ),
                              ],
                            ...
                            Padding(
                              padding: paddingData,
                              child: Text(
                                itemsProveMain.COMMAND != null
                                    ? itemsProveMain.COMMAND.toString()
                                    : "",
                                style: textStyleData,
                              ),
                            ),
                            ...
                            itemsProveMain.IS_SCIENCE == 1
                              ...
                              children: <Widget>[
                                ...
                                Padding(
                                  padding: paddingData,
                                  child: Text(
                                    itemsProveScience.DELIVERY_DOC_NO_1 +
                                        " / " +
                                        itemsProveScience
                                            .DELIVERY_DOC_NO_2,
                                    style: textStyleData,
                                ...
                                Padding(
                                  padding: paddingData,
                                  child: Text(
                                    _convertDate(itemsProveScience
                                        .DELIVERY_DOC_DATE) +
                                        " " +
                                        _convertTime(itemsProveScience
                                            .DELIVERY_DOC_DATE),
                                    style: textStyleData,
                                  ),
                                ),
                                ...
                                Padding(
                                  padding: paddingData,
                                  child: Text(
                                    itemsProveScience.REQUEST_DOC_NO
                                        .toString(),
                                    style: textStyleData,
                                  ),
                                ),
                                ...
                                Padding(
                                  padding: paddingData,
                                  child: Text(
                                    itemsProveScience.RESULT_DOC_NO
                                        .toString(),
                                    style: textStyleData,
                                  ),
                                ),
                ...
                Container(
                  ...
                  child: Container(
                    ...
                    child: GestureDetector(
                      onTap: (){
                        _navigateProveResult(context, false, true);
                      },
                      child: Row(
                        mainAxisAlignment:
                        MainAxisAlignment.spaceBetween,
                      ...
                      Padding(
                        ...
                        child: Text(
                          itemsProveMain.DELIVERY_DOC_DATE!=null
                              ...
                              ' ' +
                              _convertTime(itemsProveMain.DELIVERY_DOC_DATE))
                              :"",
                          style: textStyleData,
                        ),
                      ),
