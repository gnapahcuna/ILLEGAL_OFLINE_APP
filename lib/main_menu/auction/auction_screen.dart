  ...
  Widget _buildContent_tab_2() {
                  ...
                  children: <Widget>[
                    ...
                    Container(
                      ...
                      child: Row(
                        children: <Widget>[
                          Text(
                            /*"วันที่จัดเก็บ"*/"วันที่ขายของกลาง", style: textLabelStyle,),
                          Text("*", style: textStyleStar,),
                        ],
                      ),
                    ),
    ...
    Widget _buildContent_saved(BuildContext context) {
      ...
      Widget _buildExpandableContent(int index) {
        ...
        return ExpandableNotifier(
          controller: itemEvidence[index].ItemsController
              .expController,
          child: Stack(
            children: <Widget>[
              Expandable(
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      ...
                      Container(
                        padding: paddingLabel,
                        child: Text(/*"วันที่จัดเก็บ"*/"วันที่ขายของกลาง", style: textLabelStyle,),
                      ),
                      Padding(
                        padding: paddingInputBox,
                        child: Text(
