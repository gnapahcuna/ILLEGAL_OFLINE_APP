...
class _FragmentState extends State<AuctionMainScreenFragmentSearch2> {
  ...
  Future<bool> onLoadAction(Map map) async {
    await new ManageEvidenceFuture().apiRequestEvidenceOutListgetByConAdv(map).then((
        onValue) {
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    Container(
                      padding: paddingLabel,
                      child: Text("วันที่ขาย", style: textLabelStyle,),
                    ),
                    Padding(
                      padding: paddingInputBox,
                      child: TextField(
                        ...
                        onTap: () {
                          ...
                          showDialog(
                            ...
                            setState(() {
                              ...
                              _currentDateAuctionStart = date;
                              editAuctionDateStart.text =
                                  _currentDateAuctionStart;
                            });
                          });
                        },
                        ...
                        onTap: () {
                          ...
                          showDialog(
                            ...
                            setState(() {
                              _dtDateOfferStart = s;
                              _currentDateOfferStart = date;
                              editOfferDateStart.text =
                                  _currentDateOfferStart;
                            });
                          });
                        },
  ...
  Widget build(BuildContext context) {
    ...
    return new WillPopScope(
      ...
      appBar: PreferredSize(
        ...
        child: AppBar(
          title: new Text("ค้นหางานขายทอดตลาด",
