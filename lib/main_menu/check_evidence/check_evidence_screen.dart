...
import 'check_evidence_search_main_screen.dart';
...
class _FragmentState extends State<CheckEvidenceMainScreenFragment>  with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    if (!widget.IsCreate) {
      ...
      print("EVIDENCE_TYPE 1 : "+widget.EVIDENCE_TYPE.toString());
      ...
      if(widget.EVIDENCE_TYPE==0){
        ...
        itemsProveArrestProduct.forEach((item){
          item.controller.editQuantity.text = item.QUANTITY!=null
              ?item.QUANTITY.toInt().toString()
              :"";
          item.controller.editVolume.text = item.VOLUMN!=null
  ...
  void _setCalItem(ItemsEvidenceInItem item){
    item.ItemsController.editDeliveredNumber.text=
        item.DELIVERY_QTY.toInt().toString();
    item.ItemsController.editDefectiveNumber.text =
        item.DAMAGE_QTY.toInt().toString();
    item.ItemsController.editTotalNumber.text=
        (item.DELIVERY_QTY - item.DAMAGE_QTY).toInt().toString();

    item.ItemsController.editDeliveredVolumn.text=
        item.DELIVERY_NET_VOLUMN.toString();
    item.ItemsController.editDefectiveVolumn.text =
        item.DAMAGE_NET_VOLUMN.toInt().toString();
    item.ItemsController.editTotalVolumn.text=
        (item.DELIVERY_NET_VOLUMN - item.DAMAGE_NET_VOLUMN).toString();

    item.ItemsController.editProductUnit.text=
        item.DELIVERY_QTY_UNIT.toString();
    item.ItemsController.editVolumeUnit.text=
        item.DELIVERY_NET_VOLUMN_UNIT.toString();
  }
  ...
  void _setDataSaved() {
    ...
    //เพิ่ม item forms
    itemsFormsTab=[];
    itemsFormsTab.add(new ItemsListArrest8(
        "1. บันทึกตรวจรับของกลางเพื่อเก็บรักษา (ขก.2)",""));
    tabController =
    ...
    /*if(IsUpdate){
      itemMain.EvidenceInStaff.forEach((item){
        items.add({
          ...
          "ID_CARD": item.ID_CARD,
          "STAFF_TYPE": item.STAFF_TYPE,
          "TITLE_NAME_TH": widget.ItemsPerson.TITLE_SHORT_NAME_THitem.TITLE_SHORT_NAME_TH,
          "TITLE_NAME_EN": item.TITLE_NAME_EN,
          "TITLE_SHORT_NAME_TH": widget.ItemsPerson.TITLE_SHORT_NAME_THitem.TITLE_SHORT_NAME_TH,
          "TITLE_SHORT_NAME_EN": item.TITLE_SHORT_NAME_EN,
          "FIRST_NAME": widget.ItemsPerson.FIRST_NAMEitem.FIRST_NAME,
          "LAST_NAME": widget.ItemsPerson.LAST_NAMEitem.LAST_NAME,
          "AGE": "",
          "OPERATION_POS_CODE": "",
          "OPREATION_POS_NAME": widget.ItemsPerson.OPREATION_POS_NAMEitem.LAST_NAME,
          "OPREATION_POS_LEVEL": "",
          "OPERATION_POS_LEVEL_NAME": widget.ItemsPerson
            .OPREATION_POS_LAVEL_NAMEitem.OPERATION_POS_LEVEL_NAME,
          "OPERATION_DEPT_CODE": "",
          "OPERATION_DEPT_NAME": "",
          ...
          "OPERATION_OFFICE_CODE": widget.ItemsPerson.WorkOffCodeitem.OPERATION_OFFICE_CODE,
    ...
    if(_onEdited) {
      if (list_add_evidence_item.length > 0) {
        for (int i = 0; i < list_add_evidence_item.length; i++) {
          ...
          items_balance.add({
            ...
            "RECEIVE_NET_VOLUMN_UNIT": list_add_evidence_item[i].ItemsController.editTotalVolumnUnit.text,
            "BALANCE_QTY": "",
            "BALANCE_QTY_UNIT": "",
            "BALANCE_SIZE": "",
            "BALANCE_SIZE_UNIT": "",
            "BALANCE_NET_VOLUMN": list_add_evidence_item[i].ItemsController.editTotalVolumn.text,
            "BALANCE_NET_VOLUMN_UNIT": list_add_evidence_item[i].ItemsController.editTotalVolumnUnit.text,
            "IS_FINISH": 2,
            "IS_RECEIVE": 1
          });
          ...
          items.add({
            ...
            "EVIDENCE_IN_ID": itemMain.EVIDENCE_IN_ID,
            "PRODUCT_MAPPING_ID": "",
            "PRODUCT_CODE": list_add_evidence_item[i].PRODUCT_CODE == null
                ? ""
                : list_add_evidence_item[i].PRODUCT_CODE,
            "PRODUCT_REF_CODE": list_add_evidence_item[i].PRODUCT_REF_CODE ==
                null ? "" : list_add_evidence_item[i].PRODUCT_REF_CODE,
            "PRODUCT_GROUP_ID": list_add_evidence_item[i].PRODUCT_GROUP_ID,
            "PRODUCT_CATEGORY_ID": list_add_evidence_item[i]
                .PRODUCT_CATEGORY_ID,
            "PRODUCT_TYPE_ID": list_add_evidence_item[i].PRODUCT_TYPE_ID,
            "PRODUCT_SUBTYPE_ID": list_add_evidence_item[i].PRODUCT_SUBTYPE_ID,
            "PRODUCT_SUBSETTYPE_ID": list_add_evidence_item[i]
                .PRODUCT_SUBSETTYPE_ID,
            "PRODUCT_BRAND_ID": list_add_evidence_item[i].PRODUCT_BRAND_ID,
            "PRODUCT_SUBBRAND_ID": list_add_evidence_item[i]
                .PRODUCT_SUBBRAND_ID,
            "PRODUCT_MODEL_ID": list_add_evidence_item[i].PRODUCT_MODEL_ID,
            "PRODUCT_TAXDETAIL_ID": list_add_evidence_item[i]
                .PRODUCT_TAXDETAIL_ID,
            "PRODUCT_GROUP_CODE": list_add_evidence_item[i]
                .PRODUCT_GROUP_CODE == null ? "" : list_add_evidence_item[i]
                .PRODUCT_GROUP_CODE,
            "PRODUCT_GROUP_NAME": list_add_evidence_item[i]
                .PRODUCT_GROUP_NAME == null ? "" : list_add_evidence_item[i]
                .PRODUCT_GROUP_NAME,
            "PRODUCT_CATEGORY_CODE": list_add_evidence_item[i]
                .PRODUCT_CATEGORY_CODE == null ? "" : list_add_evidence_item[i]
                .PRODUCT_CATEGORY_CODE,
            "PRODUCT_CATEGORY_NAME": list_add_evidence_item[i]
                .PRODUCT_CATEGORY_NAME == null ? "" : list_add_evidence_item[i]
                .PRODUCT_CATEGORY_NAME,
            "PRODUCT_TYPE_CODE": list_add_evidence_item[i].PRODUCT_TYPE_CODE ==
                null ? "" : list_add_evidence_item[i].PRODUCT_TYPE_CODE,
            "PRODUCT_TYPE_NAME": list_add_evidence_item[i].PRODUCT_TYPE_NAME ==
                null ? "" : list_add_evidence_item[i].PRODUCT_TYPE_NAME,
            "PRODUCT_SUBTYPE_CODE": list_add_evidence_item[i]
                .PRODUCT_SUBTYPE_CODE == null ? "" : list_add_evidence_item[i]
                .PRODUCT_SUBTYPE_CODE,
            "PRODUCT_SUBTYPE_NAME": list_add_evidence_item[i]
                .PRODUCT_SUBTYPE_NAME == null ? "" : list_add_evidence_item[i]
                .PRODUCT_SUBTYPE_NAME,
            "PRODUCT_SUBSETTYPE_CODE": list_add_evidence_item[i]
                .PRODUCT_SUBSETTYPE_CODE == null
                ? ""
                : list_add_evidence_item[i].PRODUCT_SUBSETTYPE_CODE,
            "PRODUCT_SUBSETTYPE_NAME": list_add_evidence_item[i]
                .PRODUCT_SUBSETTYPE_NAME == null
                ? ""
                : list_add_evidence_item[i].PRODUCT_SUBSETTYPE_NAME,
            "PRODUCT_BRAND_CODE": list_add_evidence_item[i]
                .PRODUCT_BRAND_CODE == null ? "" : list_add_evidence_item[i]
                .PRODUCT_BRAND_CODE,
            "PRODUCT_BRAND_NAME_TH": list_add_evidence_item[i]
                .PRODUCT_BRAND_NAME_TH == null ? "" : list_add_evidence_item[i]
                .PRODUCT_BRAND_NAME_TH,
            "PRODUCT_BRAND_NAME_EN": list_add_evidence_item[i]
                .PRODUCT_BRAND_NAME_EN == null ? "" : list_add_evidence_item[i]
                .PRODUCT_BRAND_NAME_EN,
            "PRODUCT_SUBBRAND_CODE": list_add_evidence_item[i]
                .PRODUCT_SUBBRAND_CODE == null ? "" : list_add_evidence_item[i]
                .PRODUCT_SUBBRAND_CODE,
            "PRODUCT_SUBBRAND_NAME_TH": list_add_evidence_item[i]
                .PRODUCT_SUBBRAND_NAME_TH == null
                ? ""
                : list_add_evidence_item[i].PRODUCT_SUBBRAND_NAME_TH,
            "PRODUCT_SUBBRAND_NAME_EN": list_add_evidence_item[i]
                .PRODUCT_SUBBRAND_NAME_EN == null
                ? ""
                : list_add_evidence_item[i].PRODUCT_SUBBRAND_NAME_EN,
            "PRODUCT_MODEL_CODE": list_add_evidence_item[i]
                .PRODUCT_MODEL_CODE == null ? "" : list_add_evidence_item[i]
                .PRODUCT_MODEL_CODE,
            "PRODUCT_MODEL_NAME_TH": list_add_evidence_item[i]
                .PRODUCT_MODEL_NAME_TH == null ? "" : list_add_evidence_item[i]
                .PRODUCT_MODEL_NAME_TH,
            "PRODUCT_MODEL_NAME_EN": list_add_evidence_item[i]
                .PRODUCT_MODEL_NAME_EN == null ? "" : list_add_evidence_item[i]
            ...
            "DELIVERY_NET_VOLUMN": list_add_evidence_item[i]
                .DELIVERY_NET_VOLUMN,
            "DELIVERY_NET_VOLUMN_UNIT": list_add_evidence_item[i]
                .DELIVERY_NET_VOLUMN_UNIT,
            "DAMAGE_QTY": int.parse(
                list_add_evidence_item[i].ItemsController.editDefectiveNumber
                    .text),
            ...
            "DAMAGE_NET_VOLUMN": double.parse(
                list_add_evidence_item[i].ItemsController.editDefectiveVolumn
                    .text),
            "DAMAGE_NET_VOLUMN_UNIT": list_add_evidence_item[i]
                .DELIVERY_NET_VOLUMN_UNIT,
            "IS_DOMESTIC": 0,
            "IS_ACTIVE": 1,
            "EvidenceOutStockBalance": items_balance
          });
        }
      } else {
        print('this loop ');
        for (int i = 0; i < itemEvidence.length; i++) {
          print('this loop '+itemEvidence[i].ItemsController.editDefectiveNumber.text);
          ...
          items_balance.add({
            ...
            "RECEIVE_NET_VOLUMN_UNIT": itemEvidence[i].ItemsController.editTotalVolumnUnit.text,
            "BALANCE_QTY": "",
            "BALANCE_QTY_UNIT": "",
            "BALANCE_SIZE": "",
            "BALANCE_SIZE_UNIT": "",
            "BALANCE_NET_VOLUMN": itemEvidence[i].ItemsController.editTotalVolumn.text,
            "BALANCE_NET_VOLUMN_UNIT": itemEvidence[i].ItemsController.editTotalVolumnUnit.text,
            "IS_FINISH": 2,
            "IS_RECEIVE": 1
          });
          ...
          items.add({
            ...
            "PRODUCT_CODE": itemEvidence[i].PRODUCT_CODE == null
                ? ""
                : itemEvidence[i].PRODUCT_CODE,
            "PRODUCT_REF_CODE": itemEvidence[i].PRODUCT_REF_CODE == null
                ? ""
                : itemEvidence[i].PRODUCT_REF_CODE,
            ...
            "PRODUCT_GROUP_CODE": itemEvidence[i].PRODUCT_GROUP_CODE == null
                ? ""
                : itemEvidence[i].PRODUCT_GROUP_CODE,
            "PRODUCT_GROUP_NAME": itemEvidence[i].PRODUCT_GROUP_NAME == null
                ? ""
                : itemEvidence[i].PRODUCT_GROUP_NAME,
            "PRODUCT_CATEGORY_CODE": itemEvidence[i].PRODUCT_CATEGORY_CODE ==
                null ? "" : itemEvidence[i].PRODUCT_CATEGORY_CODE,
            "PRODUCT_CATEGORY_NAME": itemEvidence[i].PRODUCT_CATEGORY_NAME ==
                null ? "" : itemEvidence[i].PRODUCT_CATEGORY_NAME,
            "PRODUCT_TYPE_CODE": itemEvidence[i].PRODUCT_TYPE_CODE == null
                ? ""
                : itemEvidence[i].PRODUCT_TYPE_CODE,
            "PRODUCT_TYPE_NAME": itemEvidence[i].PRODUCT_TYPE_NAME == null
                ? ""
                : itemEvidence[i].PRODUCT_TYPE_NAME,
            "PRODUCT_SUBTYPE_CODE": itemEvidence[i].PRODUCT_SUBTYPE_CODE ==
                null
                ? ""
                : itemEvidence[i].PRODUCT_SUBTYPE_CODE,
            "PRODUCT_SUBTYPE_NAME": itemEvidence[i].PRODUCT_SUBTYPE_NAME ==
                null
                ? ""
                : itemEvidence[i].PRODUCT_SUBTYPE_NAME,
            "PRODUCT_SUBSETTYPE_CODE": itemEvidence[i]
                .PRODUCT_SUBSETTYPE_CODE == null ? "" : itemEvidence[i]
                .PRODUCT_SUBSETTYPE_CODE,
            "PRODUCT_SUBSETTYPE_NAME": itemEvidence[i]
                .PRODUCT_SUBSETTYPE_NAME == null ? "" : itemEvidence[i]
                .PRODUCT_SUBSETTYPE_NAME,
            "PRODUCT_BRAND_CODE": itemEvidence[i].PRODUCT_BRAND_CODE == null
                ? ""
                : itemEvidence[i].PRODUCT_BRAND_CODE,
            "PRODUCT_BRAND_NAME_TH": itemEvidence[i].PRODUCT_BRAND_NAME_TH ==
                null ? "" : itemEvidence[i].PRODUCT_BRAND_NAME_TH,
            "PRODUCT_BRAND_NAME_EN": itemEvidence[i].PRODUCT_BRAND_NAME_EN ==
                null ? "" : itemEvidence[i].PRODUCT_BRAND_NAME_EN,
            "PRODUCT_SUBBRAND_CODE": itemEvidence[i].PRODUCT_SUBBRAND_CODE ==
                null ? "" : itemEvidence[i].PRODUCT_SUBBRAND_CODE,
            "PRODUCT_SUBBRAND_NAME_TH": itemEvidence[i]
                .PRODUCT_SUBBRAND_NAME_TH == null ? "" : itemEvidence[i]
                .PRODUCT_SUBBRAND_NAME_TH,
            "PRODUCT_SUBBRAND_NAME_EN": itemEvidence[i]
                .PRODUCT_SUBBRAND_NAME_EN == null ? "" : itemEvidence[i]
                .PRODUCT_SUBBRAND_NAME_EN,
            "PRODUCT_MODEL_CODE": itemEvidence[i].PRODUCT_MODEL_CODE == null
                ? ""
                : itemEvidence[i].PRODUCT_MODEL_CODE,
            "PRODUCT_MODEL_NAME_TH": itemEvidence[i].PRODUCT_MODEL_NAME_TH ==
                null ? "" : itemEvidence[i].PRODUCT_MODEL_NAME_TH,
            "PRODUCT_MODEL_NAME_EN": itemEvidence[i].PRODUCT_MODEL_NAME_EN ==
                null ? "" : itemEvidence[i].PRODUCT_MODEL_NAME_EN,
            ...
            "DELIVERY_NET_VOLUMN_UNIT": itemEvidence[i]
                .DELIVERY_NET_VOLUMN_UNIT,
            "DAMAGE_QTY": int.parse(
            ...
            "DAMAGE_NET_VOLUMN_UNIT": itemEvidence[i]
                .DELIVERY_NET_VOLUMN_UNIT,
            "IS_DOMESTIC": 0,
            "IS_ACTIVE": 1,
            "EvidenceOutStockBalance": items_balance
      ...
      for (int i = 0; i < itemEvidence.length; i++) {
        if (IsUpdate) {
          ...
          items.add({
            "EVIDENCE_IN_ITEM_ID": itemEvidence[i].EVIDENCE_IN_ITEM_ID,
            "EVIDENCE_IN_ITEM_CODE": itemMain.IS_RECEIVE == 1 ? itemEvidence[i]
                .EVIDENCE_IN_ITEM_CODE : transec[i],
            "EVIDENCE_IN_ID": itemEvidence[i].EVIDENCE_IN_ID,
            "PRODUCT_MAPPING_ID": itemEvidence[i].PRODUCT_MAPPING_ID,
            "PRODUCT_CODE": itemEvidence[i].PRODUCT_CODE == null
            ...
            "PRODUCT_TYPE_NAME": itemEvidence[i].PRODUCT_TYPE_NAME == null
                ? ""
                : itemEvidence[i].PRODUCT_TYPE_NAME,
            "PRODUCT_SUBTYPE_CODE": itemEvidence[i].PRODUCT_SUBTYPE_CODE == null
                ? ""
                : itemEvidence[i].PRODUCT_SUBTYPE_CODE,
            "PRODUCT_SUBTYPE_NAME": itemEvidence[i].PRODUCT_SUBTYPE_NAME == null
                ? ""
                : itemEvidence[i].PRODUCT_SUBTYPE_NAME,
            "PRODUCT_SUBSETTYPE_CODE": itemEvidence[i]
                .PRODUCT_SUBSETTYPE_CODE == null ? "" : itemEvidence[i]
    ...
    await new TransectionFuture()
      ...
      if (_itemTransection.length != 0) {
        ...
        String date_auto = (int.parse(
            ...
            .substring(2);
        transection_no =
            "RC" + widget.ItemsPerson.WorkOffCode + date_auto + "00001";
      }
    });
    ...
    if(IsUpdate){
      if(itemMain!=null){
        ...
        if(itemMain.IS_RECEIVE!=1){
          for(int i=0;i< itemEvidence.length;i++){
            Map map_transec = {
              "RUNNING_PREFIX": "IN",
              "PRODUCT_GROUP_ID": itemEvidence[i].PRODUCT_GROUP_ID.toString(),
              "WAREHOUSE_ID": dropdownValueStock.WAREHOUSE_ID
            };
            await new TransectionFuture()
                .apiRequestTransactionRunningItemgetByCon(map_transec)
                .then((onValue) {
              ...
              if (_itemTransectionitem.length != 0) {
                ...
                transection_item_no = /*_itemTransectionitem.last.RUNNING_PREFIX*/"IN"
                    + warehouse_no + product_group_no +
                    _itemTransectionitem.last.RUNNING_YEAR + transection_item_no;
                ...
                transection_item_no =
                    "IN" + warehouse_no + product_group_no + date_auto + "00001";
              }
            });
            ...
            if (IsEvidenceItemCode) {
              ...
              await new TransectionFuture()
                  .apiRequestTransactionRunningItemupdByCon(map_tran_up)
                  .then((onValue) {
              ...
              print(map_tran_ins.toString());
              await new TransectionFuture().apiRequestTransactionRunningIteminsAll(
                  map_tran_ins).then((onValue) {
      ...
      for (int i = 0; i < itemEvidence.length; i++) {
        ...
        await new TransectionFuture()
            ...
            .then((onValue) {
          _itemTransectionitem = onValue;
          print("_itemTransectionitem : " +
              _itemTransectionitem.length.toString());
          if (_itemTransectionitem.length != 0) {
            IsEvidenceItemCode = true;
            transection_item_no =
                (_itemTransectionitem.first.RUNNING_NO + 1).toString();
            if (transection_item_no.length != 5) {
              String sum = "";
              for (int i = 0; i < 5 - transection_item_no.length; i++) {
                sum += "0";
            ...
            String product_group_no = itemEvidence[i].PRODUCT_GROUP_ID
                .toString();
            if (product_group_no != 4) {
              String sum = "";
              for (int i = 0; i < 4 - product_group_no
                  .toString()
                  .length; i++) {
                sum += "0";
              }
  ...
  Future<bool> onLoadActionEvidenceInsAll(int EVIDENCE_IN_TYPE) async {
    ...
    print(_createMapEvidenceItem(false, tran_item));
    ...
    if(EVIDENCE_IN_TYPE==0){
      map_evidence = {
        ...
        "EVIDENCE_IN_DATE": _deriveredDate.toString(),
        "RETURN_DATE": "",
        "IS_RECEIVE": 1,
    ...
    if(EVIDENCE_IN_ID!=null){
      Map map_con = {
        ...
        "PROVE_ID": IsReceiveProve?itemsEvidenceArrest.PROVE_ID:""
      };
      await new CheckEvidenceFuture()
          .apiRequestEvidenceIngetByCon(map_con)
          .then((onValue) {
        if(onValue!=null){
          itemMain = onValue;
          itemEvidence =itemMain.EvidenceInItem;
  ...
  Future<bool> onLoadActionEvidenceUpdAll() async {
    ...
    print("report : "+DateTime.now().toString());
    ...
    Map map_evidence = {
      ...
      "IS_ACTIVE": 1,
      "IS_EDIT": 1,
      "EvidenceInStaff": _createMapStaff(true, 13,[])
    };

    //update
    await new CheckEvidenceFuture()
        .apiRequestEvidenceInupdByCon(map_evidence)
        .then((onValue) {
    ...
    await new CheckEvidenceFuture()
        .apiRequestEvidenceInItemupdByCon(_createMapEvidenceItem(true,tran_item))
        .then((onValue) {
    ...
    if(map_del_item.length>0){
      await new CheckEvidenceFuture()
          .apiRequestEvidenceInItemupdDelete(map_del_item)
          .then((onValue) {
    ...
    if(list_add_evidence_item.length>0){
      await new CheckEvidenceFuture()
          .apiRequestEvidenceInIteminsAll(_createMapEvidenceItem(false,tran_item))
          .then((onValue) {
  ...
  navigateDeliveredBook(BuildContext context,index,bool IsUpdate) async {
    final result = await Navigator.push(
      context,
      MaterialPageRoute(
          builder: (context) => DeliveryBookSearchScreenFragment(IsUpdate: IsUpdate,
          )),
    );
    if (result.toString() != "Back") {
      setState(() {
                    ...
                    children: <Widget>[
                      Container(
                        ...
                        child: Row(
                          children: <Widget>[
                            Text(
                              "เลขหนังสือนำส่งจัดเก็บจากหน่วยงานภายนอก", style: textStyleLabel,),
                            Text("*", style: textStyleStar,),
                          ],
                        ),
                      ),
                      ...
                      Container(
                        ...
                        child: Row(
                          children: <Widget>[
                            Text(
                              "หน่วยงานนำส่ง", style: textStyleLabel,),
                            Text("*", style: textStyleStar,),
                          ],
                        ),
                      ),
                      ...
                      Container(
                        ...
                        child: Row(
                          children: <Widget>[
                            Text(
                              "เวลานำส่ง", style: textStyleLabel,),
                            Text("*", style: textStyleStar,),
                          ],
                        ),
                      ),
                      ...
                      Container(
                        ...
                        child: Row(
                          children: <Widget>[
                            Text(
                              "วันที่กำหนดคืนของกลาง", style: textStyleLabel,),
                            Text("*", style: textStyleStar,),
                          ],
                        ),
                      ),
                ...
                Container(
                    ...
                    child: _onExport ? (
                      !IsReceiveProve
                        ...
                        children: <Widget>[
                          Container(
                            padding: paddingLabel,
                            child: Text(
                              "เลขหนังสือนำส่ง", style: textStyleLabel,),
                          ),
                          Padding(
                            padding: paddingData,
                            child: Text(
                          ...
                          Padding(
                            padding: paddingData,
                            child: Text(
                              _convertDate(itemMain.DELIVERY_DATE) + " " +
                                  _convertTime1(itemMain.DELIVERY_DATE),
                              style: textStyleData,),
                          ),
                          Container(
                            padding: paddingLabel,
                          ...
                          Padding(
                            padding: paddingData,
                            child: Text(
                              get_staff_name(itemMain.EvidenceInStaff,59), style: textStyleData,),
                          ),
                        ],
                      )
                          :Column(
                        ...
                        children: <Widget>[
                          ...
                          Padding(
                            padding: paddingData,
                            child: Text(
                              get_office_name(itemMain.EvidenceInStaff, 59),
                              style: textStyleData,
                            ),
                          ),
                          /*Container(
                      ...
                      children: <Widget>[
                        Container(
                          padding: paddingLabel,
                          child: Text("เลขหนังสือนำส่งจัดเก็บจากหน่วยงานภายนอก",
                            style: textStyleLabel,),
                        ),
                        Padding(
                          padding: paddingData,
                        ...
                        Padding(
                          padding: paddingData,
                          child: Text(
                            itemMain.RETURN_DATE != null ? _convertDate(
                                itemMain.RETURN_DATE) : "",
                            style: textStyleData,),
                        ),
                        Container(
                          padding: paddingLabel,
                          child: Text("หน่วยงานนำส่ง", style: textStyleLabel,),
                        ),
                        Padding(
                          padding: paddingData,
                          child: Text(
                      ...
                      children: <Widget>[
                        /*Container(
                          padding: paddingLabel,
                          child: Text(
                            "เลขหนังสือนำส่งจัดเก็บ", style: textStyleLabel,),
                        ),
                        Padding(
                          padding: paddingData,
                          child: Text(
                            itemsEvidenceArrest.DELIVERY_DOC_NO_1.toString(),
                            style: textStyleData,),
                        ),
                        Padding(
                          padding: paddingData,
                        ...
                        Padding(
                          padding: paddingData,
                          child: Text(
                            itemsEvidenceArrest.DELIVERY_DOC_NO_2.toString(),
                            style: textStyleData,),
                        ),
                        Container(
                          padding: paddingLabel,
                        ...
                        Padding(
                          padding: paddingData,
                          child: Text(
                            _convertDate(itemsEvidenceArrest.DELIVERY_DATE) +
                                " " +
                                _convertTime(itemsEvidenceArrest.DELIVERY_TIME),
                            style: textStyleData,),
                        ),
                        Container(
                          padding: paddingLabel,
                        ...
                        Padding(
                          padding: paddingData,
                          child: Text(
                            itemsEvidenceArrest.RECEIVER_OFFICE_SHORT_NAME
                                .toString(),
                            style: textStyleData,),
                        ),
                        Container(
                          padding: paddingLabel,
                          child: Text("เลขคดี", style: textStyleLabel,),
                        ),
                        Padding(
                          padding: paddingData,
                          child: Text(
                            itemsEvidenceArrest.LAWSUIT_NO.toString() + "/" +
                                _convertYear(
                                    itemsEvidenceArrest.LAWSUIT_NO_YEAR),
                            style: textStyleData,),
                        ),
                        Container(
                          padding: paddingLabel,
                        ...
                        Padding(
                          padding: paddingData,
                          child: Text(
                            itemsEvidenceArrest.PROVE_NO.toString(),
                            style: textStyleData,),
                        ),
                        Container(
                          padding: paddingLabel,
                          child: Text("ผู้พิสูจน์", style: textStyleLabel,),
                        ),
                        Padding(
                          padding: paddingData,
                          child: Text(
                            *//* itemInforDelivered.Comment*//*
                            "Unknow", style: textStyleData,),
                        ),*/
                        ...
                        Padding(
                          padding: paddingData,
                          child: Text(
                            get_staff_name(itemMain.EvidenceInStaff, 59)!=null
                                ?get_staff_name(itemMain.EvidenceInStaff, 59)
                                :"",
                            style: textStyleData,
                          ),
                        ...
                        Padding(
                          padding: paddingData,
                          child: Text(
                            get_office_name(itemMain.EvidenceInStaff, 59)!=null
                                ?get_office_name(itemMain.EvidenceInStaff, 59)
                                :"",
                            style: textStyleData,
                          ),
...
//************************end_tab_1*******************************
  ...
  Widget _buildContent_tab_2() {
    Widget _buildExpandableContent(int index) {
      ...
      print("IsReceiveProve : "+IsReceiveProve.toString());
      ...
      Widget _buildExpanded(index) {
        return Stack(
          children: <Widget>[
                ...
                ? Column(
                  ...
                  children: <Widget>[
                    ...
                    Container(
                      padding: paddingData,
                      child: Text(
                        itemEvidence[index].EVIDENCE_IN_ITEM_CODE, style: textStyleData,),
                    ),
                    Container(
                      padding: paddingLabel,
                      child: Text(
                              ...
                              children: <Widget>[
                                ...
                                IgnorePointer(
                                  ...
                                  child:Padding(
                                    padding: paddingData,
                                    child: TextField(
                                      focusNode: itemEvidence[index].ItemsController
                                ...
                                IgnorePointer(
                                  ...
                                  child: Padding(
                                    ...
                                    child: TextField(
                                      ...
                                      controller: itemEvidence[index]
                                          .ItemsController.editDeliveredVolumn,
                                      keyboardType: TextInputType.number,
                                      textCapitalization: TextCapitalization
                                          .words,
                                      style: textStyleData,
                              ...
                              children: <Widget>[
                                ...
                                Padding(
                                  ...
                                  child: TextField(
                                    ...
                                    controller: itemEvidence[index]
                                        .ItemsController.editDefectiveVolumn,
                                    keyboardType: TextInputType.number,
                                    textCapitalization: TextCapitalization
                                        .words,
                                    style: textStyleData,
                                ...
                                new IgnorePointer(
                                  ...
                                  child: Padding(
                                    ...
                                    child: TextField(
                                      ...
                                      controller: itemEvidence[index]
                                          .ItemsController.editTotalVolumn,
                                      keyboardType: TextInputType.number,
                                      textCapitalization: TextCapitalization
                                          .words,
                                      style: textStyleData,
                        ...
                        children: <Widget>[
                          new Container(
                            ...
                            child: TextField(
                              ...
                              controller: itemEvidence[index]
                                  .ItemsController.editEvidenceComment,
            ...
            widget.EVIDENCE_TYPE==3||widget.EVIDENCE_TYPE==4?Padding(
        ...
        return Column(
          ...
          children: <Widget>[
            ...
            Container(
              padding: paddingData,
              child: Text(
                itemEvidence[index].EVIDENCE_IN_ITEM_CODE!=null
                  ...
                  children: <Widget>[
                    ...
                    Container(
                      ...
                      child: Row(
                        children: <Widget>[
                          Text(
                            "ผู้ตรวจรับของกลาง", style: textStyleLabel,),
                          Text("*", style: textStyleStar,),
                        ],
                      ),
                    ),
                    ...
                    Container(
                      ...
                      child: Row(
                        children: <Widget>[
                          Text(
                            "ประธานกรรมการ ", style: textStyleLabel,),
                        ],
                      ),
                    ),
                    Container(
                    ...
                    Container(
                      ...
                      child: Row(
                        children: <Widget>[
                          Text(
                            "กรรมการและเลขานุการ  ", style: textStyleLabel,),
                        ],
                      ),
                    ),
                    Container(
              ...
              Container(
                ...
                child: _buildButtonImgPicker(),
                  ...
                  child: SingleChildScrollView(
                    scrollDirection: Axis.horizontal,
                    child: Row(
                      mainAxisAlignment: widget.EVIDENCE_TYPE == 3 || widget.EVIDENCE_TYPE == 4
              ...
              Column(
                ...
                children: <Widget>[
                  ...
                  Container(
                    padding: paddingData,
                    child: Text(
                      _setItemName(itemEvidence[index]), style: textStyleData,),
                  ),
                  SingleChildScrollView(
                    scrollDirection: Axis.horizontal,
                    child: Row(
                        ...
                        Container(
                          ...
                          child: Column(
                            ...
                            children: <Widget>[
                              ...
                              Container(
                                padding: paddingData,
                                child: Text(itemEvidence[index].DELIVERY_QTY.toInt().toString(), style: textStyleData,),
                              ),
                            ],
                          ),
                        ),
                        Container(
                          ...
                          child: Column(
                            ...
                            children: <Widget>[
                              ...
                              Container(
                                padding: paddingData,
                                child: Text(itemEvidence[index].DAMAGE_QTY.toInt().toString(), style: textStyleData,),
                              ),
                            ],
                          ),
                        ),
                        Container(
                          ...
                          child: Column(
                            ...
                            children: <Widget>[
                              ...
                              Container(
                                padding: paddingData,
                                child: Text((itemEvidence[index].DELIVERY_QTY-
                                    itemEvidence[index].DAMAGE_QTY).toInt().toString(), style: textStyleData,),
                              ),
                            ],
                          ),
                        ),
                        Container(
                          ...
                          child: Column(
                            ...
                            children: <Widget>[
                              ...
                              Container(
                                padding: paddingData,
                                child: Text(itemEvidence[index].DELIVERY_QTY_UNIT.toString(), style: textStyleData,),
                              ),
                            ],
                          ),
                        ),
                        ...
                        Container(
                          ...
                          child: Column(
                            ...
                            children: <Widget>[
                              ...
                              Container(
                                padding: paddingData,
                                child: Text(itemEvidence[index].DELIVERY_NET_VOLUMN.toString(), style: textStyleData,),
                              ),
                            ],
                          ),
                        ),
                        Container(
                          ...
                          child: Column(
                            ...
                            children: <Widget>[
                              ...
                              Container(
                                padding: paddingData,
                                child: Text(itemEvidence[index].DAMAGE_NET_VOLUMN.toString(), style: textStyleData,),
                              ),
                            ],
                          ),
                        ),
                        Container(
                          ...
                          child: Column(
                            ...
                            children: <Widget>[
                              ...
                              Container(
                                padding: paddingData,
                                child: Text((itemEvidence[index].DELIVERY_NET_VOLUMN-
                                    itemEvidence[index].DAMAGE_NET_VOLUMN).toString(), style: textStyleData,),
                              ),
                            ],
                          ),
                        ),
                        Container(
                          ...
                          child: Column(
                            ...
                            children: <Widget>[
                              ...
                              Container(
                                padding: paddingData,
                                child: Text(itemEvidence[index].DELIVERY_NET_VOLUMN_UNIT.toString(), style: textStyleData,),
                              ),
                            ],
                          ),
                        ),
                  ...
                  Container(
                    padding: paddingData,
                    child: Text('', style: textStyleData,),
                  ),
                ],
              ),
            ],
                ...
                Container(
                  ...
                  child: _onExport?Column(
                    ...
                    children: <Widget>[
                      ...
                      Container(
                        padding: paddingLabel,
                        child: Text("ผู้ตรวจรับของกลาง", style: textStyleLabel,),
                      ),
                      Padding(
                        padding: paddingData,
                        child: Text(
                          get_staff_name(itemMain.EvidenceInStaff,60), style: textStyleData,),
                      ),
                      Container(
                        padding: paddingLabel,
                        child: Text("ประธานกรรมการ ", style: textStyleLabel,),
                      ),
                      Padding(
                        padding: paddingData,
                        child: Text(
                          get_staff_name(itemMain.EvidenceInStaff,61)!=null
                              ?get_staff_name(itemMain.EvidenceInStaff,61)
                              :"", style: textStyleData,),
                      ),
                      Container(
                        padding: paddingLabel,
                        child: Text("กรรมการ", style: textStyleLabel,),
                      ),
                      Padding(
                        padding: paddingData,
                        child: Text(
                          get_staff_name(itemMain.EvidenceInStaff,62)!=null
                              ?get_staff_name(itemMain.EvidenceInStaff,62)
                              :"", style: textStyleData,),
                      ),
                      Container(
                        padding: paddingLabel,
                        child: Text("กรรมการและเลขานุการ", style: textStyleLabel,),
                      ),
                      Padding(
                        padding: paddingData,
                        child: Text(
                          get_staff_name(itemMain.EvidenceInStaff,63)!=null
                              ?get_staff_name(itemMain.EvidenceInStaff,63)
                              :"", style: textStyleData,),
                      ),
                      Container(
                        padding: paddingLabel,
                    ...
                    children: <Widget>[
                      ...
                      Padding(
                        padding: paddingData,
                        child: Text(
                          get_staff_name(itemMain.EvidenceInStaff,60)!=null
                              ?get_staff_name(itemMain.EvidenceInStaff,60)
                              :"", style: textStyleData,),
                      ),
                      Container(
                        padding: paddingLabel,
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              Padding(
                padding: paddingData,
                child: Text(
                  _convertDate(itemsEvidenceArrest.OCCURRENCE_DATE) + " " +
                      _convertTime(itemsEvidenceArrest.OCCURRENCE_TIME),
                  style: textStyleData,),
              ),
              Container(
                padding: paddingLabel,
              ...
              Padding(
                padding: paddingData,
                child: Text(
                  itemsEvidenceArrest.SUBSECTION_NO!=null
                      ?itemsEvidenceArrest.SUBSECTION_NO.toString()
                      :"",
                  style: textStyleData,),
              ),
              Container(
              ...
              Container(
                padding: paddingLabel,
                child: Text("เลขรับคดีคำกล่าวโทษ  ", style: textStyleLabel,),
              ),
              Padding(
                padding: paddingData,
                child: Text(
                  itemsEvidenceArrest.LAWSUIT_NO+"/"+_convertYear(itemsEvidenceArrest.LAWSUIT_NO_YEAR),
                  style: textStyleData,),
              ),
              Container(
                padding: paddingLabel,
              ...
              Padding(
                padding: paddingData,
                child: Text(
                  _convertDate(itemsEvidenceArrest.LAWSUIT_DATE)+" "
                      +_convertTime(itemsEvidenceArrest.LAWSUIT_TIME),
                  style: textStyleData,),
              ),
              /*Container(
                padding: paddingLabel,
                                ...
                                setState(() {
                                  ...
                                  if (IsProductStorageAll) {
                                    ...
                                    itemsProveArrestProduct.forEach((item) {
                                      item.IS_CHECK = true;
                                      itemEvidence.add(
                                          new ItemsEvidenceInItem(
                                              EVIDENCE_IN_ITEM_ID: null,
                                              EVIDENCE_IN_ITEM_CODE: null,
                                              EVIDENCE_IN_ID: null,
                                              PRODUCT_MAPPING_ID: item
                                                  .PRODUCT_MAPPING_ID,
                                              PRODUCT_CODE: item
                                                  .PRODUCT_CODE,
                                              PRODUCT_REF_CODE: item
                                                  .PRODUCT_REF_CODE,
                                              ...
                                              PRODUCT_TYPE_ID: item
                                                  .PRODUCT_TYPE_ID,
                                              PRODUCT_SUBTYPE_ID: item
                                                  .PRODUCT_SUBTYPE_ID,
                                              PRODUCT_SUBSETTYPE_ID: item
                                                  .PRODUCT_SUBSETTYPE_ID,
                                              PRODUCT_BRAND_ID: item
                                                  .PRODUCT_BRAND_ID,
                                              PRODUCT_SUBBRAND_ID: item
                                                  .PRODUCT_SUBBRAND_ID,
                                              PRODUCT_MODEL_ID: item
                                                  .PRODUCT_MODEL_ID,
                                              PRODUCT_TAXDETAIL_ID: item
                                                  .PRODUCT_TAXDETAIL_ID,
                                              ...
                                              PRODUCT_TYPE_NAME: item
                                                  .PRODUCT_TYPE_NAME,
                                              PRODUCT_SUBTYPE_CODE: item
                                                  .PRODUCT_SUBTYPE_CODE != null
                                                  ? int.parse(
                                                  item
                                                      .PRODUCT_SUBTYPE_CODE)
                                                  : null,
                                              PRODUCT_SUBTYPE_NAME: item
                                                  .PRODUCT_SUBTYPE_NAME,
                                              PRODUCT_SUBSETTYPE_CODE: item
                                                  .PRODUCT_SUBSETTYPE_CODE !=
                                                  null
                                                  ? int.parse(
                                                  item
                                                      .PRODUCT_SUBSETTYPE_CODE)
                                                  : null,
                                              PRODUCT_SUBSETTYPE_NAME: item
                                                  .PRODUCT_SUBSETTYPE_NAME,
                                              PRODUCT_BRAND_CODE: item
                                                  .PRODUCT_BRAND_CODE != null
                                                  ? int.parse(
                                                  item
                                                      .PRODUCT_BRAND_CODE)
                                                  : null,
                                              PRODUCT_BRAND_NAME_TH: item
                                                  .PRODUCT_BRAND_NAME_TH,
                                              PRODUCT_BRAND_NAME_EN: item
                                                  .PRODUCT_BRAND_NAME_EN,
                                              PRODUCT_SUBBRAND_CODE: item
                                                  .PRODUCT_SUBBRAND_CODE != null
                                                  ? int.parse(
                                                  item
                                                      .PRODUCT_SUBBRAND_CODE)
                                                  : null,
                                              PRODUCT_SUBBRAND_NAME_TH: item
                                                  .PRODUCT_SUBBRAND_NAME_TH,
                                              PRODUCT_SUBBRAND_NAME_EN: item
                                                  .PRODUCT_SUBBRAND_NAME_EN,
                                              PRODUCT_MODEL_CODE: item
                                                  .PRODUCT_MODEL_CODE != null
                                                  ? int.parse(
                                                  item
                                                      .PRODUCT_MODEL_CODE)
                                                  : null,
                                              PRODUCT_MODEL_NAME_TH: item
                                                  .PRODUCT_MODEL_NAME_TH,
                                              PRODUCT_MODEL_NAME_EN: item
                                                  .PRODUCT_MODEL_NAME_EN,
                                              LICENSE_PLATE: item
                                                  .LICENSE_PLATE,
                                              ENGINE_NO: item
                                              ...
                                              PRICE: item
                                                  .PRICE,
                                              DELIVERY_QTY: double.parse(
                                                  item
                                                      .controller.editQuantity
                                                      .text),
                                              DELIVERY_QTY_UNIT: item
                                                  .QUANTITY_UNIT,
                                              DELIVERY_SIZE: item
                                                  .SIZES != null
                                                  ? item
                                                  .SIZES
                                                  : 0,
                                              DELIVERY_SIZE_UNIT: item
                                                  .SIZES_UNIT,
                                              DELIVERY_NET_VOLUMN: double.parse(
                                                  item
                                                      .controller.editVolume
                                                      .text),
                                              DELIVERY_NET_VOLUMN_UNIT: item
                                                  .VOLUMN_UNIT,
                                              DAMAGE_QTY: 0,
                                              DAMAGE_QTY_UNIT: "",
                                              DAMAGE_SIZE: 0,
                                    ...
                                    if(itemsProveArrestProduct[j].IS_CHECK) {
                                      itemEvidence.add(
                                          new ItemsEvidenceInItem(
                                              ...
                                              EVIDENCE_IN_ITEM_CODE: null,
                                              EVIDENCE_IN_ID: null,
                                              PRODUCT_MAPPING_ID: itemsProveArrestProduct[j]
                                                  .PRODUCT_MAPPING_ID,
                                              PRODUCT_CODE: itemsProveArrestProduct[j]
                                                  .PRODUCT_CODE,
                                              PRODUCT_REF_CODE: itemsProveArrestProduct[j]
                                                  .PRODUCT_REF_CODE,
                                              PRODUCT_GROUP_ID: itemsProveArrestProduct[j]
                                                  .PRODUCT_GROUP_ID,
                                              PRODUCT_CATEGORY_ID: itemsProveArrestProduct[j]
                                                  .PRODUCT_CATEGORY_ID,
                                              PRODUCT_TYPE_ID: itemsProveArrestProduct[j]
                                                  .PRODUCT_TYPE_ID,
                                              PRODUCT_SUBTYPE_ID: itemsProveArrestProduct[j]
                                                  .PRODUCT_SUBTYPE_ID,
                                              PRODUCT_SUBSETTYPE_ID: itemsProveArrestProduct[j]
                                                  .PRODUCT_SUBSETTYPE_ID,
                                              PRODUCT_BRAND_ID: itemsProveArrestProduct[j]
                                                  .PRODUCT_BRAND_ID,
                                              PRODUCT_SUBBRAND_ID: itemsProveArrestProduct[j]
                                                  .PRODUCT_SUBBRAND_ID,
                                              PRODUCT_MODEL_ID: itemsProveArrestProduct[j]
                                                  .PRODUCT_MODEL_ID,
                                              PRODUCT_TAXDETAIL_ID: itemsProveArrestProduct[j]
                                                  .PRODUCT_TAXDETAIL_ID,
                                              PRODUCT_GROUP_CODE: itemsProveArrestProduct[j]
                                                  .PRODUCT_GROUP_CODE != null
                                                  ? int.parse(
                                                  itemsProveArrestProduct[j]
                                                      .PRODUCT_GROUP_CODE)
                                                  : null,
                                              PRODUCT_GROUP_NAME: itemsProveArrestProduct[j]
                                                  .PRODUCT_GROUP_NAME,
                                              PRODUCT_CATEGORY_CODE: itemsProveArrestProduct[j]
                                                  .PRODUCT_CATEGORY_CODE != null
                                                  ? int.parse(
                                                  itemsProveArrestProduct[j]
                                                      .PRODUCT_CATEGORY_CODE)
                                                  : null,
                                              PRODUCT_CATEGORY_NAME: itemsProveArrestProduct[j]
                                                  .PRODUCT_CATEGORY_NAME,
                                              PRODUCT_TYPE_CODE: itemsProveArrestProduct[j]
                                                  .PRODUCT_TYPE_CODE != null
                                                  ? int.parse(
                                                  itemsProveArrestProduct[j]
                                                      .PRODUCT_TYPE_CODE)
                                                  : null,
                                              PRODUCT_TYPE_NAME: itemsProveArrestProduct[j]
                                                  .PRODUCT_TYPE_NAME,
                                              PRODUCT_SUBTYPE_CODE: itemsProveArrestProduct[j]
                                                  .PRODUCT_SUBTYPE_CODE != null
                                                  ? int.parse(
                                                  itemsProveArrestProduct[j]
                                                      .PRODUCT_SUBTYPE_CODE)
                                                  : null,
                                              PRODUCT_SUBTYPE_NAME: itemsProveArrestProduct[j]
                                                  .PRODUCT_SUBTYPE_NAME,
                                              PRODUCT_SUBSETTYPE_CODE: itemsProveArrestProduct[j]
                                                  .PRODUCT_SUBSETTYPE_CODE !=
                                                  null
                                                  ? int.parse(
                                                  itemsProveArrestProduct[j]
                                                      .PRODUCT_SUBSETTYPE_CODE)
                                                  : null,
                                              PRODUCT_SUBSETTYPE_NAME: itemsProveArrestProduct[j]
                                                  .PRODUCT_SUBSETTYPE_NAME,
                                              PRODUCT_BRAND_CODE: itemsProveArrestProduct[j]
                                                  .PRODUCT_BRAND_CODE != null
                                                  ? int.parse(
                                                  itemsProveArrestProduct[j]
                                                      .PRODUCT_BRAND_CODE)
                                                  : null,
                                              PRODUCT_BRAND_NAME_TH: itemsProveArrestProduct[j]
                                                  .PRODUCT_BRAND_NAME_TH,
                                              PRODUCT_BRAND_NAME_EN: itemsProveArrestProduct[j]
                                                  .PRODUCT_BRAND_NAME_EN,
                                              PRODUCT_SUBBRAND_CODE: itemsProveArrestProduct[j]
                                                  .PRODUCT_SUBBRAND_CODE != null
                                                  ? int.parse(
                                                  itemsProveArrestProduct[j]
                                                      .PRODUCT_SUBBRAND_CODE)
                                                  : null,
                                              PRODUCT_SUBBRAND_NAME_TH: itemsProveArrestProduct[j]
                                                  .PRODUCT_SUBBRAND_NAME_TH,
                                              PRODUCT_SUBBRAND_NAME_EN: itemsProveArrestProduct[j]
                                                  .PRODUCT_SUBBRAND_NAME_EN,
                                              PRODUCT_MODEL_CODE: itemsProveArrestProduct[j]
                                                  .PRODUCT_MODEL_CODE != null
                                                  ? int.parse(
                                                  itemsProveArrestProduct[j]
                                                      .PRODUCT_MODEL_CODE)
                                                  : null,
                                              PRODUCT_MODEL_NAME_TH: itemsProveArrestProduct[j]
                                                  .PRODUCT_MODEL_NAME_TH,
                                              PRODUCT_MODEL_NAME_EN: itemsProveArrestProduct[j]
                                                  .PRODUCT_MODEL_NAME_EN,
                                              LICENSE_PLATE: itemsProveArrestProduct[j]
                                                  .LICENSE_PLATE,
                                              ENGINE_NO: itemsProveArrestProduct[j]
                                                  .ENGINE_NO,
                                              CHASSIS_NO: itemsProveArrestProduct[j]
                                                  .CHASSIS_NO,
                                              PRODUCT_DESC: itemsProveArrestProduct[j]
                                                  .PRODUCT_DESC,
                                              SUGAR: itemsProveArrestProduct[j]
                                                  .SUGAR,
                                              CO2: itemsProveArrestProduct[j]
                                                  .CO2,
                                              DEGREE: itemsProveArrestProduct[j]
                                                  .DEGREE,
                                              PRICE: itemsProveArrestProduct[j]
                                                  .PRICE,
                                              DELIVERY_QTY: double.parse(
                                                  itemsProveArrestProduct[j]
                                                      .controller.editQuantity
                                                      .text),
                                              DELIVERY_QTY_UNIT: itemsProveArrestProduct[j]
                                                  .QUANTITY_UNIT,
                                              DELIVERY_SIZE: itemsProveArrestProduct[j]
                                                  .SIZES != null
                                                  ? itemsProveArrestProduct[j]
                                                  .SIZES
                                                  : 0,
                                              DELIVERY_SIZE_UNIT: itemsProveArrestProduct[j]
                                                  .SIZES_UNIT,
                                              DELIVERY_NET_VOLUMN: double.parse(
                                                  itemsProveArrestProduct[j]
                                                      .controller.editVolume
                                                      .text),
                                              DELIVERY_NET_VOLUMN_UNIT: itemsProveArrestProduct[j]
                                                  .VOLUMN_UNIT,
                                              DAMAGE_QTY: 0,
                                              DAMAGE_QTY_UNIT: "",
                                              DAMAGE_SIZE: 0,
                                              ...
                                              DAMAGE_NET_VOLUMN: 0,
                                              DAMAGE_NET_VOLUMN_UNIT: "",
                                              IS_DOMESTIC: itemsProveArrestProduct[j]
                                                  .IS_DOMESTIC,
                                              IS_ACTIVE: null,
                                              ItemsController: new ItemsCheckEvidenceDetailController(
                                                  new ExpandableController(),
          ...
          children: <Widget>[
            Container(
              ...
              child: Container(
                padding: paddingLabel,
                child: Text(
                  "รายการของกลางที่นำส่ง", style: textStyleLabel,),
              ),
            ),
            Container(
                padding: EdgeInsets.only(bottom: 22.0),
