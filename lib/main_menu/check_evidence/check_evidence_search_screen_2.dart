...
class _FragmentState extends State<CheckEvidenceMainScreenFragmentSearch2> {
  ...
  Future<bool> onLoadAction(Map map) async {
    await new CheckEvidenceFuture().apiRequestEvidenceInListgetByConAdv(map).then((
        onValue) {
      List<ItemsEvidenceList> itemsComplete=[];
      List<ItemsEvidenceList> itemsNonComplete=[];
      onValue.forEach((f){
        if(f.EVIDENCE_IN_ID==null||f.EVIDENCE_IN_ID==0){
                            ...
                            child: MaterialButton(
                              onPressed: () {
                                ...
                                Map map = {
                                  ...
                                  "EVIDENCE_IN_DATE_START": editLawsuitDateStart
                                    .text.isEmpty ? "" : DateFormat('yyyy-MM-dd').format(_dtDateLawsuitStart).toString(),
                                  "EVIDENCE_IN_DATE_TO": editLawsuitDateEnd
                                      .text.isEmpty ? "" : DateFormat('yyyy-MM-dd').format(_dtDateLawsuitEnd).toString(),
      ...
      child: new Column(
        ...
        children: <Widget>[
          Container(
            ...
            child: Text("ประเภทการตรวจรับของกลาง", style: textLabelStyle,),
          ),
                          ...
                          children: <Widget>[
                            InkWell(
                              ...
                              child: Container(
                                decoration: BoxDecoration(
                                  shape: BoxShape.circle,
                                  color: IsInside ? Color(0xff3b69f3) : Colors
                                      .white,
                                  border: Border.all(color: Colors.black12),
                                ),
                                child: Padding(
                          ...
                          children: <Widget>[
                            InkWell(
                              ...
                              child: Container(
                                decoration: BoxDecoration(
                                  shape: BoxShape.circle,
                                  color: IsOutGov ? Color(0xff3b69f3) : Colors
                                      .white,
                                  border: Border.all(color: Colors.black12),
                                ),
                                child: Padding(
          ...
          Container(
            //padding: paddingLabel,
            child: Text("สถานะการตรวจรับของกลาง", style: textLabelStyle,),
          ),
          SingleChildScrollView(
            scrollDirection: Axis.horizontal,
            child: Row(
                    ...
                    children: <Widget>[
                      InkWell(
                        ...
                        child: Container(
                          decoration: BoxDecoration(
                            shape: BoxShape.circle,
                            color: IsEvidenceComplete ? Color(0xff3b69f3) : Colors
                                .white,
                            border: Border.all(color: Colors.black12),
                          ),
                          child: Padding(
          ...
          Container(
            padding: paddingLabel,
            child: Text("เลขที่หนังสือนำส่ง", style: textLabelStyle,),
          ),
          Padding(
          ...
          Container(
            padding: paddingLabel,
            child: Text("เลขที่รับ", style: textLabelStyle,),
          ),
          Padding(
            padding: paddingInputBox,
            child: TextField(
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    Container(
                      padding: paddingLabel,
                      child: Text("วันที่รับของกลาง", style: textLabelStyle,),
                    ),
                    Padding(
                      padding: paddingInputBox,
                      child: TextField(
          ...
          Container(
            padding: paddingLabel,
            child: Text("ชื่อผู้ตรวจรับของกลาง", style: textLabelStyle,),
          ),
          Padding(
            padding: paddingInputBox,
            child: TextField(
